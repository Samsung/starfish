...
internal_test_part1:
	./tool/drivers/run_test.py basic tool/reftest/efl/internal_part1.res common -p$(TEST_NPROCS)
internal_test_part2:
	./tool/drivers/run_test.py basic tool/reftest/efl/internal_part2.res common -p$(TEST_NPROCS)
internal_test_part3:
	./tool/drivers/run_test.py basic tool/reftest/efl/internal_part3.res common -p$(TEST_NPROCS)
internal_test_part4:
	./tool/drivers/run_test.py basic tool/reftest/efl/internal_part4.res common -p$(TEST_NPROCS)
internal_test_part5:
	./tool/drivers/run_test.py basic tool/reftest/efl/internal_part5.res common -p$(TEST_NPROCS)
...
dom_conformance_test:
	./tool/drivers/run_test.py dom_conformance tool/reftest/efl/dom_conformance_test.res common -p$(TEST_NPROCS)
dom_conformance_test_webkit:
	./tool/drivers/run_test.py dom_conformance tool/reftest/efl/webkit_dom_conformance_test.res common -p$(TEST_NPROCS)
...
web_platform_test_dom_events:
	./tool/drivers/run_test.py multi_basic tool/reftest/efl/wpt_dom_events.res common -p$(TEST_NPROCS)
web_platform_test_html:
	./tool/drivers/run_test.py multi_basic tool/reftest/efl/wpt_html.res common -p$(TEST_NPROCS)
web_platform_test_page_visibility:
	./tool/drivers/run_test.py multi_basic tool/reftest/efl/wpt_page_visibility.res common -p$(TEST_NPROCS)
...
vendor_test_blink_fast_html:
	./tool/drivers/run_test.py vendor_basic tool/reftest/efl/blink_fast_html.res common -p$(TEST_NPROCS)
...
vendor_test_webkit_fast_dom:
	./tool/drivers/run_test.py vendor_basic tool/reftest/efl/webkit_fast_dom.res common -p$(TEST_NPROCS)
vendor_test_webkit_fast_html:
	./tool/drivers/run_test.py vendor_basic tool/reftest/efl/webkit_fast_html.res common -p$(TEST_NPROCS)
...
internal_test_part1_cairo:
	./tool/drivers/run_test.py basic tool/reftest/cairo/internal_part1.res common -p$(TEST_NPROCS)
internal_test_part2_cairo:
	./tool/drivers/run_test.py basic tool/reftest/cairo/internal_part2.res common -p$(TEST_NPROCS)
internal_test_part3_cairo:
	./tool/drivers/run_test.py basic tool/reftest/cairo/internal_part3.res common -p$(TEST_NPROCS)
internal_test_part4_cairo:
	./tool/drivers/run_test.py basic tool/reftest/cairo/internal_part4.res common -p$(TEST_NPROCS)
internal_test_part5_cairo:
	./tool/drivers/run_test.py basic tool/reftest/cairo/internal_part5.res common -p$(TEST_NPROCS)
internal_test_manual_cairo:
	./tool/drivers/run_test.py basic tool/reftest/cairo/internal_manual.res common --font-dep -p$(TEST_NPROCS)

dom_conformance_test_cairo:
	./tool/drivers/run_test.py dom_conformance tool/reftest/cairo/dom_conformance_test.res common -p$(TEST_NPROCS)
dom_conformance_test_webkit_cairo:
	./tool/drivers/run_test.py dom_conformance tool/reftest/cairo/webkit_dom_conformance_test.res common -p$(TEST_NPROCS)
...
vendor_test_blink_fast_html_cairo:
	./tool/drivers/run_test.py vendor_basic tool/reftest/cairo/blink_fast_html.res common -p$(TEST_NPROCS)
...
vendor_test_webkit_fast_dom_cairo:
	./tool/drivers/run_test.py vendor_basic tool/reftest/cairo/webkit_fast_dom.res common -p$(TEST_NPROCS)
vendor_test_webkit_fast_html_cairo:
	./tool/drivers/run_test.py vendor_basic tool/reftest/cairo/webkit_fast_html.res common -p$(TEST_NPROCS)
...
wpt_css_color_cairo:
	...
	./tool/drivers/run_test.py csswg tool/reftest/cairo/wpt/css_css-color-3_dev_manual.res cairo --font-dep -p$(TEST_NPROCS)
