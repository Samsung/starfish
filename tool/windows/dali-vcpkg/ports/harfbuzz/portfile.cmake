...
# HarfBuzz 2.5.3 installs hb.h under include/harfbuzz but omits that
# directory from harfbuzz::harfbuzz INTERFACE_INCLUDE_DIRECTORIES.
file(APPEND "${CURRENT_PACKAGES_DIR}/share/harfbuzz/harfbuzzConfig.cmake" "
get_filename_component(_HARFBUZZ_VCPKG_PREFIX \"\${CMAKE_CURRENT_LIST_DIR}/../..\" ABSOLUTE)
set_property(TARGET harfbuzz::harfbuzz APPEND PROPERTY INTERFACE_INCLUDE_DIRECTORIES \"\${_HARFBUZZ_VCPKG_PREFIX}/include/harfbuzz\")
unset(_HARFBUZZ_VCPKG_PREFIX)
")