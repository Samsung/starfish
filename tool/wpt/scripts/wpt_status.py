...
from wpt_manifest_inventory import (DEFAULT_TARGETS, SERVER,  # noqa: E402
...
# ensure_manifest is re-exported for the existing test_runner.py caller;
# actually defined in wpt_reftest.py, the lowest-level module
