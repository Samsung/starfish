...
void BinaryStream::get( char & c )
{
    stream.get( c );
}

void BinaryStream::get( char * s, std::streamsize n )
{
    stream.get( s, n );
}

void BinaryStream::ignore( std::streamsize n)
{
    stream.ignore( n);
}

void BinaryStream::read( char * s, std::streamsize n )
{
    stream.read( s, n );
}
