...
# STARFISH_WEBWORKER_HOST: code blocks in this scope are only for sw host.
...
SET (STARFISH_WEBWORKER_DEPENDENCIES escargot tuv nanomsg)
...
SET (STARFISH_WEBWORKER_DEPENDENCIES  ${STARFISH_WEBWORKER_DEPENDENCIES} skia_matrix)
SET (STARFISH_WEBWORKER_LIBRARIES_THIRD_PARTY  ${STARFISH_WEBWORKER_LIBRARIES_THIRD_PARTY} skia_matrix)
SET (STARFISH_WEBWORKER_INCLUDE_ADDITIONAL_DIRS
...
ADD_DEPENDENCIES (${STARFISH_WEBWORKER_OBJECT_LIBRARY}
    ${STARFISH_WEBWORKER_DEPENDENCIES}
    ${JS2C_DEPENDENCIES})
...
set(WEBWORKER_CXXFLAGS ${LWE_CXXFLAGS})
set(WEBWORKER_LDFLAGS ${LWE_LDFLAGS})

message (STATUS "WebWorker")
message (STATUS "FLAGS: " ${WEBWORKER_CXXFLAGS})
message (STATUS "LIBRARIES: " ${STARFISH_WEBWORKER_LINK_LIBRARIES})
message (STATUS "DEFINITIONS: " ${STARFISH_WEBWORKER_DEFINITIONS})
message (STATUS "LDFLAGS: " ${WEBWORKER_LDFLAGS})
...
TARGET_COMPILE_OPTIONS (${STARFISH_WEBWORKER_OBJECT_LIBRARY} PUBLIC ${WEBWORKER_CXXFLAGS})
...
TARGET_COMPILE_OPTIONS (starfish.webworker PUBLIC ${WEBWORKER_CXXFLAGS})

TARGET_LINK_LIBRARIES (starfish.webworker ${STARFISH_WEBWORKER_LINK_LIBRARIES} ${WEBWORKER_LDFLAGS})
