...
IF (${HOST} STREQUAL "linux" OR ${CUSTOM} STREQUAL "prod_tv" OR ${CUSTOM} STREQUAL "unified_tv" OR ${CUSTOM} STREQUAL "unified_mobile" OR ${CUSTOM} STREQUAL "unified_wearable"  OR ${CUSTOM} STREQUAL "flutter")
    ...
    ELSE()
        ...
        ADD_CUSTOM_COMMAND (OUTPUT ${LIBWEBSOCKETS_LOCAL_TARGET}
                            ...
                            COMMENT "BUILD LIBWEBSOCKETS"
                            COMMAND ${CMAKE_COMMAND} -E make_directory ${LIBWEBSOCKETS_BUILD_OUTDIR}
                            COMMAND test -f ${LIBWEBSOCKETS_LOCAL_TARGET} || ${CMAKE_COMMAND} -S . -B${LIBWEBSOCKETS_BUILD_OUTDIR} -G Ninja ${LIBWEBSOCKETS_BUILD_OPTION} ${LIBWEBSOCKETS_CROSS_OPTION} -DCMAKE_C_COMPILER=${THIRD_PARTY_C_COMPILER_OPTION} -DCMAKE_CXX_COMPILER=${THIRD_PARTY_CXX_COMPILER_OPTION}
                            COMMAND test -f ${LIBWEBSOCKETS_LOCAL_TARGET} || ${CMAKE_COMMAND} --build ${LIBWEBSOCKETS_BUILD_OUTDIR}
                            COMMAND touch ${LIBWEBSOCKETS_LOCAL_TARGET}
        )
    ENDIF()
