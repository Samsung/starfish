...
IF (${ENABLE_MULTI_BACKEND} STREQUAL "1" OR (${ARCH} STREQUAL "x64" AND
        (${BACKEND} STREQUAL "dali" OR  ${BACKEND} STREQUAL "uv_cairo_gl" OR ${WORKER} STREQUAL "1" OR ${SHARED_WORKER} STREQUAL "1" OR ${SERVICE_WORKER} STREQUAL "1")))
...
ELSEIF (${ENABLE_MULTI_BACKEND} STREQUAL "1" OR (${HOST} STREQUAL "tizen" AND (${BACKEND} STREQUAL "dali" OR ${BACKEND} STREQUAL "flutter" OR ${BACKEND} STREQUAL "uv_cairo_gl"
...
ENDIF()
    ADD_CUSTOM_COMMAND (OUTPUT ${WEBP_LOCAL_TARGET}
                        ...
                        COMMAND cd ${WEBP_BUILD_DIR} && CC=${CMAKE_C_COMPILER} CXX=${CMAKE_CXX_COMPILER} CFLAGS=${WEBP_BUILD_OPTION} ${CMAKE_COMMAND} ${WEBP_OPTION}
...
IF (${ENABLE_MULTI_BACKEND} STREQUAL "1" OR (${ARCH} STREQUAL "x64" AND (${BACKEND} STREQUAL "uv_cairo_gl" OR ${BACKEND} STREQUAL "dali")))
