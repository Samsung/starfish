...
IF (${HOST} STREQUAL "linux")
    # SET (WEBRTC "1")
ELSEIF (${CUSTOM} STREQUAL "unified_tv" AND ((${TIZEN_MAJOR_VERSION} GREATER 6) OR (${TIZEN_MAJOR_VERSION} EQUAL 6)))
    IF (NOT ${BACKEND} STREQUAL "dali")
        SET (WEBRTC "1")
    ENDIF()
ENDIF()
...
ELSEIF (${BACKEND} STREQUAL "efl" AND ${HOST} STREQUAL "tizen")
    pkg_check_modules (STARFISH_BACKEND REQUIRED dlog libpng freetype2 fontconfig harfbuzz elementary ecore ecore-imf-evas efl-extension )
    IF (${BUILD_CAIRO} STREQUAL "0")
        pkg_check_modules (STARFISH_BACKEND_CAIRO REQUIRED cairo)
    ENDIF()
...
ELSEIF (${BACKEND} STREQUAL "dali" AND ${HOST} STREQUAL "tizen")
    pkg_check_modules (STARFISH_BACKEND REQUIRED dlog libpng freetype2 fontconfig harfbuzz elementary ecore)
...
IF (${HOST} STREQUAL "tizen")
    ...
    ELSEIF (${CUSTOM} STREQUAL "prod_tv")
        pkg_check_modules (STARFISH_TIZEN_CUSTOM REQUIRED vconf-internal-keys-tv capi-network-connection capi-media-player tts capi-media-audio-io capi-appfw-app-common)
