...
if (CMAKE_CXX_COMPILER_VERSION VERSION_GREATER 9)
    SET (LWE_CXXFLAGS_COMPILER ${LWE_CXXFLAGS_COMPILER} -Wno-attributes -Wno-class-memaccess -Wno-deprecated-copy -Wno-cast-function-type -Wno-stringop-truncation -Wno-pessimizing-move -Wno-strict-aliasing)
endif()
...
SET (LWE_CXXFLAGS ${LWE_CXXFLAGS_DEFAULT} ${LWE_CXXFLAGS_COMPILER} ${LWE_CXXFLAGS_HOST} ${LWE_CXXFLAGS_BACKEND} ${LWE_CXXFLAGS_MODE} ${LWE_CXXFLAGS_LTO} ${LWE_CXXFLAGS_ASAN} ${CXXFLAGS_FROM_ENV})
...
ELSEIF (${BACKEND} STREQUAL "efl" AND ${HOST} STREQUAL "tizen")
    pkg_check_modules (STARFISH_BACKEND REQUIRED libpng freetype2 fontconfig harfbuzz elementary ecore ecore-imf-evas efl-extension )
    IF (${BUILD_CAIRO} STREQUAL "0")
        pkg_check_modules (STARFISH_BACKEND_CAIRO REQUIRED cairo)
    ENDIF()
...
ELSEIF (${BACKEND} STREQUAL "dali" AND ${ARCH} STREQUAL "x64")
    pkg_check_modules (STARFISH_BACKEND REQUIRED libpng freetype2 fontconfig harfbuzz elementary ecore)
    IF (${BUILD_CAIRO} STREQUAL "0")
        pkg_check_modules (STARFISH_BACKEND_CAIRO REQUIRED cairo)
    ENDIF()
...
IF (${HOST} STREQUAL "tizen")
    ...
    ELSEIF (${CUSTOM} STREQUAL "prod_tv")
        pkg_check_modules (STARFISH_TIZEN_CUSTOM REQUIRED dlog vconf-internal-keys-tv capi-network-connection capi-media-player tts capi-media-audio-io capi-appfw-app-common capi-media-camera capi-media-tool capi-system-device)
...
SET (STARFISH_OPENSSL_ADDITIONAL_INCLUDE_DIRS
