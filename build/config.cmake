...
ELSEIF ((${BACKEND} STREQUAL "glfw_cairo_gl" OR ${BACKEND} STREQUAL "x11_cairo_gl") AND ${ARCH} STREQUAL "x64")
    SET (DEFAULT_PACKAGES freetype2 fontconfig harfbuzz)
    IF (${WEBGL} STREQUAL "1")
...
IF (${BACKEND} MATCHES "efl_cairo" OR ${BACKEND} STREQUAL "ecore_wayland2_cairo_gl" OR ${BACKEND} STREQUAL "dali" OR ${BACKEND} STREQUAL "flutter" OR ${BACKEND} STREQUAL "uv_cairo_gl")
...
ELSEIF (${BACKEND} STREQUAL "glfw_cairo_gl" OR ${BACKEND} STREQUAL "x11_cairo_gl")
    IF (${BACKEND} STREQUAL "glfw_cairo_gl")
        SET (STARFISH_LIBRARIES_BACKEND GL GLESv2)
    ELSEIF (${BACKEND} STREQUAL "x11_cairo_gl")
        SET (STARFISH_LIBRARIES_BACKEND GLESv2 EGL)
    ENDIF()
    IF (${ARCH} STREQUAL "x64")
        IF (${USE_EMBEDDED_IMAGE_DECODER} STREQUAL "0")
