...
SET (LWE_CXXFLAGS ${LWE_CXXFLAGS_DEFAULT} ${LWE_CXXFLAGS_COMPILER} ${LWE_CXXFLAGS_HOST} ${LWE_CXXFLAGS_BACKEND} ${LWE_CXXFLAGS_MODE} ${LWE_CXXFLAGS_LTO} ${CXXFLAGS_FROM_ENV})
...
SET (LWE_LDFLAGS ${LWE_LDFLAGS_DEFAULT} ${LWE_LDFLAGS_HOST} ${LWE_LDFLAGS_LTO} ${LDFLAGS_FROM_ENV})
#######################################################
# PACKAGES
#######################################################
