...
# vcpkg baseline. The DALi overlay gives its Debug DLL and import library a
# `d` postfix, whereas the regular port does not. Model both configurations
# explicitly so a multi-config generator never links cairo.lib while deploying
# cairod.dll from vcpkg's debug/bin.
FIND_PATH (STARFISH_VCPKG_CAIRO_INCLUDE_DIR cairo.h PATH_SUFFIXES cairo REQUIRED)
FIND_LIBRARY (STARFISH_VCPKG_CAIRO_LIBRARY_RELEASE NAMES cairo
    PATHS "${VCPKG_INSTALLED_DIR}/${VCPKG_TARGET_TRIPLET}/lib"
    NO_DEFAULT_PATH REQUIRED)
FIND_LIBRARY (STARFISH_VCPKG_CAIRO_LIBRARY_DEBUG NAMES cairod cairo
    PATHS "${VCPKG_INSTALLED_DIR}/${VCPKG_TARGET_TRIPLET}/debug/lib"
    NO_DEFAULT_PATH REQUIRED)
ADD_LIBRARY (starfish.vcpkg.cairo UNKNOWN IMPORTED GLOBAL)
SET_TARGET_PROPERTIES (starfish.vcpkg.cairo PROPERTIES
    IMPORTED_CONFIGURATIONS "DEBUG;RELEASE;RELWITHDEBINFO;MINSIZEREL"
    IMPORTED_LOCATION_DEBUG "${STARFISH_VCPKG_CAIRO_LIBRARY_DEBUG}"
    IMPORTED_LOCATION_RELEASE "${STARFISH_VCPKG_CAIRO_LIBRARY_RELEASE}"
    IMPORTED_LOCATION_RELWITHDEBINFO "${STARFISH_VCPKG_CAIRO_LIBRARY_RELEASE}"
    IMPORTED_LOCATION_MINSIZEREL "${STARFISH_VCPKG_CAIRO_LIBRARY_RELEASE}"
    INTERFACE_INCLUDE_DIRECTORIES "${STARFISH_VCPKG_CAIRO_INCLUDE_DIR}")
