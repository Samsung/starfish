...
ELSEIF (${SHELL} STREQUAL "ecore_x")
    SET(STARFISH_SHELL_LIBRARIES ecore ecore-x ecore-input ecore-imf evas glib-2.0)
ELSEIF (${SHELL} STREQUAL "ecore_wl2")
    SET(STARFISH_SHELL_LIBRARIES ecore ecore-wl2 ecore-input ecore-imf evas glib-2.0 wayland-client)
ELSEIF (${SHELL} STREQUAL "tcore_wl")
...
ELSEIF (${SHELL} STREQUAL "x11")
    ...
    IF(${BACKEND} STREQUAL "glib_cairo_gl")
        SET(STARFISH_SHELL_LIBRARIES ${STARFISH_SHELL_LIBRARIES} glib-2.0)
    ENDIF()
ELSEIF (${SHELL} STREQUAL "glfw")
    IF(${BACKEND} STREQUAL "glib_cairo_gl")
        SET(STARFISH_SHELL_LIBRARIES glib-2.0)
