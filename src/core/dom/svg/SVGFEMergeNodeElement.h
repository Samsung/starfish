...
#ifndef __StarfishSVGMergeNodeElement__
#define __StarfishSVGMergeNodeElement__
...
public:
    SVGFEMergeNodeElement(Document* document, const QualifiedName& qname)
    ...
    virtual bool isSVGFEMergeNodeElement() const override;

    static inline void fillGCDescriptor(GC_word* desc)
    {
        SVGElement::fillGCDescriptor(desc);
        GC_set_bit(desc, GC_WORD_OFFSET(SVGFEMergeNodeElement, m_in));
    }
