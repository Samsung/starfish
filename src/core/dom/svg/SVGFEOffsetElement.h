...
#ifndef __StarfishSVGFEOffsetElement__
#define __StarfishSVGFEOffsetElement__
...
public:
    SVGFEOffsetElement(Document* document, const QualifiedName& qname);
    ...
    virtual bool isSVGFEOffsetElement() const override;
