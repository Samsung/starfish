...
#ifndef __StarfishSVGFEFloodElement__
#define __StarfishSVGFEFloodElement__
...
public:
    SVGFEFloodElement(Document* document, const QualifiedName& qname);
    ...
    virtual bool isSVGFEFloodElement() const override;
