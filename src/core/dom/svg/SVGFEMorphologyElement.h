...
#ifndef __StarfishSVGFEMorphologyElement__
#define __StarfishSVGFEMorphologyElement__
...
public:
    ...
    SVGFEMorphologyElement(Document* document, const QualifiedName& qname);
    void* operator new(size_t size);
    void* operator new[](size_t size) = delete;

    virtual void init(ScriptBindingInstance* instance,
                      void* domObjectPointer) override;
    virtual bool isSVGFEMorphologyElement() const override;
