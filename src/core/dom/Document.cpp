...
DEFINE_EVENT_LISTENER(Document, touchstart);
DEFINE_EVENT_LISTENER(Document, touchend);
DEFINE_EVENT_LISTENER(Document, touchmove);
DEFINE_EVENT_LISTENER(Document, touchcancel);
