...
#undef ADD_VALUE_PAIR

    {
        ...
        CSSStyleValuePair tStyle, bStyle, lStyle, rStyle, tColor, bColor,
            lColor, rColor;
        ...
        tStyle.setBorderStyleValue(border.top().style());
        bStyle.setBorderStyleValue(border.top().style());
        lStyle.setBorderStyleValue(border.top().style());
        rStyle.setBorderStyleValue(border.top().style());
        tColor.setColorValue(border.top().color());
        bColor.setColorValue(border.bottom().color());
        lColor.setColorValue(border.left().color());
        rColor.setColorValue(border.right().color());
    }
