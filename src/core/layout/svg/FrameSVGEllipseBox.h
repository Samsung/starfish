...
#ifndef __StarfishFrameSVGEllipseBox__
#define __StarfishFrameSVGEllipseBox__

#include "core/layout/svg/FrameSVGBox.h"

namespace Starfish {

class FrameSVGEllipseBox final : public FrameSVGBox {
public:
    FrameSVGEllipseBox(Node* node)
        : FrameSVGBox(node)
    {
