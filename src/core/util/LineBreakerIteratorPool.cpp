...
static const char* uax14AssignmentsAfter =
    ...
    "$EmojiForSeqs = [\\u2764 \\U0001F441 \\U0001F466-\\U0001F469 \\U0001F48B "
    "\\U0001F5E8];"
    "$EmojiForMods = [\\u261D \\u26F9 \\u270A-\\u270D \\U0001F385 "
    "\\U0001F3C3-\\U0001F3C4 \\U0001F3CA \\U0001F3CB \\U0001F442-\\U0001F443 "
    "\\U0001F446-\\U0001F450 \\U0001F466-\\U0001F469 \\U0001F46E-\\U0001F478 "
    "\\U0001F47C \\U0001F481-\\U0001F483 \\U0001F485-\\U0001F487 \\U0001F4AA "
    "\\U0001F575 \\U0001F590 \\U0001F595 \\U0001F596 \\U0001F645-\\U0001F647 "
    "\\U0001F64B-\\U0001F64F \\U0001F6A3 \\U0001F6B4-\\U0001F6B6 \\U0001F6C0 "
    "\\U0001F918] ;" // Emoji that take Fitzpatrick modifiers
#else
    "$EmojiForSeqs = [\\u2764 \\U0001F466-\\U0001F469 \\U0001F48B];"
    "$EmojiForMods = [\\u261D \\u270A-\\u270C \\U0001F385 "
    "\\U0001F3C3-\\U0001F3C4 \\U0001F3C7 \\U0001F3CA \\U0001F442-\\U0001F443 "
    "\\U0001F446-\\U0001F450 \\U0001F466-\\U0001F469 \\U0001F46E-\\U0001F478 "
    "\\U0001F47C \\U0001F481-\\U0001F483 \\U0001F485-\\U0001F487 \\U0001F4AA "
    "\\U0001F596 \\U0001F645-\\U0001F647 \\U0001F64B-\\U0001F64F \\U0001F6A3 "
    "\\U0001F6B4-\\U0001F6B6 \\U0001F6C0] ;" // Emoji that take Fitzpatrick
                                             // modifiers
#endif
...
static const char* uax14Forward =
    ...
    "$AL_FOLLOW_CM = [$CL $CP $EX $HL $IS $SY $WJ $GL $OP $QU $BA $HY $NS $IN "
    "$NU $ALPlus];"
    ...
    "$PRcm ($ALcm | $HLcm);"
    "$POcm ($ALcm | $HLcm);"
    "($PRcm | $POcm)? ($OPcm | $HYcm)? $NUcm ($NUcm | $SYcm | $IScm)* ($CLcm | "
    "$CPcm)? ($PRcm | $POcm)?;"
...
static const char* uax14Reverse =
    ...
    "$CM+ $WJ;"
    "$CM+;"
    "$AL_FOLLOW $CM+ / ([$BK $CR $LF $NL $ZW {eof}] | $SP+ $CM+ $SP | $SP+ "
    "$CM* ([^$OP $CM $SP] | [$AL {eof}]));"
    ...
    "$CM* ($ALPlus | $HL) $CM* $PR;"
    "$CM* ($ALPlus | $HL) $CM* $PO;"
    "($CM* ($PR | $PO))? ($CM* ($CL | $CP))? ($CM* ($NU | $IS | $SY))* $CM* "
    "$NU ($CM* ($OP | $HY))? ($CM* ($PR | $PO))?;"
...
static const char* uax14SafeForward =
    "!!safe_forward;"
    "[$CM $OP $QU $CL $CP $B2 $PR $HY $BA $SP $dictionary]+ [^$CM $OP $QU $CL "
    "$CP $B2 $PR $HY $BA $dictionary];"
...
static String* makeLocaleWithBreakKeyword(BreakIteratorInfo& info)
{
    ...
    case LineBreakIteratorModeUAX14:
        ...
        break;
    case LineBreakIteratorModeUAX14Loose:
        builder.appendString("loose");
        break;
    case LineBreakIteratorModeUAX14Normal:
        builder.appendString("normal");
        break;
    case LineBreakIteratorModeUAX14Strict:
        builder.appendString("strict");
        break;
    }
    return builder.finalize();
}
