...
DEFINE_EVENT_LISTENER(Window, toggle);
...
DEFINE_EVENT_LISTENER(Window, touchstart);
DEFINE_EVENT_LISTENER(Window, touchend);
DEFINE_EVENT_LISTENER(Window, touchmove);
DEFINE_EVENT_LISTENER(Window, touchcancel);
