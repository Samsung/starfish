...
public:
    ...
    {
        StarFish* sf = ((Window*)escargot::ESVMInstance::currentInstance()
                            ->globalObject()
                            ->extraPointerData())
                           ->starFish();
...
{
    if (m_enterCount == 0) {
        STARFISH_RELEASE_ASSERT(escargot::ESVMInstance::currentInstance() ==
                                nullptr);
...
#define DEFINE_FUNCTION(functionName, parentName)              \
    escargot::ESString* functionName##String =                 \
        escargot::ESString::create(#functionName);             \
    escargot::ESFunctionObject* functionName##Function =       \
        escargot::ESFunctionObject::create(                    \
            NULL,                                              \
            [](escargot::ESVMInstance*) -> escargot::ESValue { \
...
//                                 ->defineDataProperty(functionName##String,
//           true, false, true, functionName##Function);
...
#define DEFINE_FUNCTION_NOT_CONSTRUCTOR(functionName, parentName)             \
    ...
    escargot::ESFunctionObject* functionName##Function =                      \
        escargot::ESFunctionObject::create(                                   \
            NULL,                                                             \
            [](escargot::ESVMInstance*) -> escargot::ESValue {                \
                escargot::ESVMInstance::currentInstance()->throwError(        \
                    escargot::ESValue(escargot::TypeError::create(            \
                        escargot::ESString::create("Illegal constructor")))); \
...
#define THROW_ILLEGAL_INVOCATION()                                   \
    {                                                                \
        escargot::ESVMInstance::currentInstance()->throwError(       \
            escargot::ESValue(escargot::TypeError::create(           \
                escargot::ESString::create("Illegal invocation")))); \
        STARFISH_RELEASE_ASSERT_NOT_REACHED();                       \
    }
...
void defineNativeAccessorPropertyButNeedToGenerateJSFunction(
    escargot::ESObject* obj, escargot::ESString* propertyName,
    escargot::NativeFunctionType getter, escargot::NativeFunctionType setter,
    bool isEnumerable = true, bool isConfigurable = true)
{
    bool isWritable = setter;

    escargot::ESPropertyAccessorData* accData =
        new escargot::ESPropertyAccessorData();
    accData->setJSGetter(escargot::ESFunctionObject::create(
        nullptr, getter,
        escargot::ESVMInstance::currentInstance()->strings().emptyString, 0,
        false, false));
    if (setter) {
        accData->setJSSetter(escargot::ESFunctionObject::create(
            nullptr, setter,
            escargot::ESVMInstance::currentInstance()->strings().emptyString, 1,
            false, false));
    }
...
void ScriptBindingInstance::initBinding(StarFish* sf)
{
    ...
    fetchData(this)->m_instance->globalObject()->defineDataProperty(
        escargot::ESString::create("wptTestEnd"), false, false, false,
        escargot::ESFunctionObject::create(
            nullptr,
    ...
    console->set(
        escargot::ESString::create("log"),
        escargot::ESFunctionObject::create(
            nullptr,
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                Window* wnd =
                    (Window*)instance->globalObject()->extraPointerData();
                wnd->starFish()->console()->log(
    ...
    console->set(
        escargot::ESString::create("info"),
        escargot::ESFunctionObject::create(
            nullptr,
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                Window* wnd =
                    (Window*)instance->globalObject()->extraPointerData();
                wnd->starFish()->console()->info(
                    toBrowserString(instance->currentExecutionContext()
                                        ->readArgument(0)
                                        .toString()));
                return escargot::ESValue();
    ...
    console->set(
        escargot::ESString::create("error"),
        escargot::ESFunctionObject::create(
            nullptr,
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                Window* wnd =
                    (Window*)instance->globalObject()->extraPointerData();
                wnd->starFish()->console()->error(
                    toBrowserString(instance->currentExecutionContext()
                                        ->readArgument(0)
                                        .toString()));
                return escargot::ESValue();
    ...
    console->set(
        escargot::ESString::create("warn"),
        escargot::ESFunctionObject::create(
            nullptr,
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                Window* wnd =
                    (Window*)instance->globalObject()->extraPointerData();
                wnd->starFish()->console()->warn(
                    toBrowserString(instance->currentExecutionContext()
                                        ->readArgument(0)
                                        .toString()));
                return escargot::ESValue();
    ...
    fetchData(this)->m_instance->globalObject()->defineDataProperty(
        escargot::ESString::create("console"), false, false, false, console);

#ifdef STARFISH_ENABLE_MULTI_PAGE
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        fetchData(this)->m_instance->globalObject(),
        escargot::ESString::create("location"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            return (((Window*)escargot::ESVMInstance::currentInstance()
                         ->globalObject()
                         ->extraPointerData()))
                ->location()
                ->scriptObject();
    ...
    escargot::ESFunctionObject* toStringFunction =
        escargot::ESFunctionObject::create(
            nullptr,
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                escargot::ESValue thisValue =
                    instance->currentExecutionContext()->resolveThisBinding();
                if (thisValue.isESPointer() &&
                    thisValue.asESPointer()->isESObject()) {
                    escargot::ESObject* obj =
                        thisValue.asESPointer()->asESObject();
                    if (obj->extraData() == kEscargotObjectCheckMagic) {
                        escargot::ESValue constructor =
                            thisValue.asESPointer()->asESObject()->get(
                                escargot::ESString::create("constructor"));
                        if (constructor.isObject()) {
                            escargot::ESValue constructor_name =
                                constructor.asESPointer()->asESObject()->get(
                                    escargot::ESString::create("name"));
                            String* result =
                                String::createASCIIString("[object ");
    ...
    fetchData(this)->m_orgToString =
        fetchData(this)
            ...
            ->objectPrototype()
            ->getOwnProperty(escargot::ESString::create("toString"))
            .asESPointer()
            ->asESFunctionObject();
    fetchData(this)
        ->m_instance->globalObject()
        ->objectPrototype()
        ->defineDataProperty(escargot::ESString::create("toString"), true,
                             false, true, toStringFunction);
    ...
    auto fnAddEventListener = escargot::ESFunctionObject::create(
        NULL,
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            escargot::ESValue thisValue =
                instance->currentExecutionContext()->resolveThisBinding();
            ...
            if (instance->currentExecutionContext()->argumentCount() < 2) {
                auto msg = escargot::ESString::create(
                    "Failed to execute 'addEventListener' on 'EventTaraget': "
                    "needs 2 parameter.");
                instance->throwError(
                    escargot::ESValue(escargot::TypeError::create(msg)));
            }
            escargot::ESValue firstArg =
                instance->currentExecutionContext()->readArgument(0);
            escargot::ESValue secondArg =
                instance->currentExecutionContext()->readArgument(1);
            escargot::ESValue thirdArg =
            ...
            if (firstArg.isESString() && secondArg.isESPointer() &&
                ...
                bool capture =
                    thirdArg.isBoolean() ? thirdArg.toBoolean() : false;
    ...
    EventTargetFunction->protoType()
        .asESPointer()
        ->asESObject()
        ->defineDataProperty(escargot::ESString::create("addEventListener"),
                             true, true, true, fnAddEventListener);

    auto fnRemoveEventListener = escargot::ESFunctionObject::create(
        NULL,
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            escargot::ESValue thisValue =
                instance->currentExecutionContext()->resolveThisBinding();
    ...
    EventTargetFunction->protoType()
        .asESPointer()
        ->asESObject()
        ->defineDataProperty(escargot::ESString::create("removeEventListener"),
                             true, true, true, fnRemoveEventListener);

    auto fnDispatchEvent = escargot::ESFunctionObject::create(
        NULL,
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            escargot::ESValue thisValue =
                instance->currentExecutionContext()->resolveThisBinding();
            ...
            if (firstArg.isUndefinedOrNull()) {
                escargot::ESString* msg = escargot::ESString::create(
            ...
            if (argCount == 1 && firstArg.isObject()) {
                ...
                Event* event = (Event*)firstArg.asESPointer()
                                   ->asESObject()
                                   ->extraPointerData();
    ...
    EventTargetFunction->protoType()
        .asESPointer()
        ->asESObject()
        ->defineDataProperty(escargot::ESString::create("dispatchEvent"), true,
                             true, true, fnDispatchEvent);

    DEFINE_FUNCTION_NOT_CONSTRUCTOR_WITH_PARENTFUNC(Window,
                                                    EventTargetFunction);
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        fetchData(this)->m_instance->globalObject(),
        escargot::ESString::create("window"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
    ...
    WindowFunction->protoType().asESPointer()->asESObject()->defineDataProperty(
        escargot::ESString::create("getComputedStyle"), true, true, true,
        escargot::ESFunctionObject::create(
            nullptr,
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                try {
                    ...
                    Node* node = (Node*)instance->currentExecutionContext()
                                     ...
                                     ->asESObject()
                                     ->extraPointerData();
                    escargot::ESValue pseudoElm =
                        instance->currentExecutionContext()->readArgument(1);

                    if (node->isNode() && pseudoElm.isNull()) {
                        CSSStyleDeclaration* s =
                            node->asNode()->getComputedStyle();
                        if (s) {
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        fetchData(this)->m_instance->globalObject(),
        escargot::ESString::create("document"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
#ifdef STARFISH_TC_COVERAGE
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        fetchData(this)->m_instance->globalObject(),
        escargot::ESString::create("history"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            return (((Window*)escargot::ESVMInstance::currentInstance()
                         ->globalObject()
                         ->extraPointerData()))
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        fetchData(this)->m_instance->globalObject(),
        escargot::ESString::create("navigator"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            return (((Window*)escargot::ESVMInstance::currentInstance()
                         ->globalObject()
                         ->extraPointerData()))
...
#define DECLARE_NAME_FOR_BINDING(codeName, exportName)                       \
    globalObject->defineAccessorProperty(                                    \
        ...
        [](::escargot::ESObject* obj, ::escargot::ESObject* originalObj,     \
           escargot::ESString* name, const escargot::ESValue& value) {       \
            fetchData((((Window*)escargot::ESVMInstance::currentInstance()   \
                            ->globalObject()                                 \
                            ->extraPointerData()))                           \
                          ->document()                                       \
                          ->scriptBindingInstance())                         \
...
/* 4.5.1 Interface DOMImplementation */
    ...
    DOMImplementationFunction->protoType()
        ...
        ->asESObject()
        ->defineDataProperty(
            escargot::ESString::create("createHTMLDocument"), false, false,
            false,
            escargot::ESFunctionObject::create(
                nullptr,
                [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                    GENERATE_THIS_AND_CHECK_TYPE(
                        ScriptWrappable::Type::DOMImplementationObject,
                        DOMImplementation);
    ...
    ScriptBindingInstance* scriptBindingInstance)
{
    ...
    NodeFunction->asESObject()->defineDataProperty(
        escargot::ESString::create("ELEMENT_NODE"), false, true, false,
        escargot::ESValue(Node::ELEMENT_NODE));
    NodeFunction->asESObject()->defineDataProperty(
        escargot::ESString::create("ATTRIBUTE_NODE"), false, true, false,
        escargot::ESValue(Node::ATTRIBUTE_NODE));
    NodeFunction->asESObject()->defineDataProperty(
        escargot::ESString::create("TEXT_NODE"), false, true, false,
        escargot::ESValue(Node::TEXT_NODE));
    NodeFunction->asESObject()->defineDataProperty(
        escargot::ESString::create("CDATA_SECTION_NODE"), false, true, false,
        escargot::ESValue(Node::CDATA_SECTION_NODE));
    NodeFunction->asESObject()->defineDataProperty(
        escargot::ESString::create("ENTITY_REFERENCE_NODE"), false, true, false,
        escargot::ESValue(Node::ENTITY_REFERENCE_NODE));
    NodeFunction->asESObject()->defineDataProperty(
        escargot::ESString::create("ENTITY_NODE"), false, true, false,
        escargot::ESValue(Node::ENTITY_NODE));
    NodeFunction->asESObject()->defineDataProperty(
        escargot::ESString::create("PROCESSING_INSTRUCTION_NODE"), false, true,
        false, escargot::ESValue(Node::PROCESSING_INSTRUCTION_NODE));
    NodeFunction->asESObject()->defineDataProperty(
        escargot::ESString::create("COMMENT_NODE"), false, true, false,
        escargot::ESValue(Node::COMMENT_NODE));
    NodeFunction->asESObject()->defineDataProperty(
        escargot::ESString::create("DOCUMENT_NODE"), false, true, false,
        escargot::ESValue(Node::DOCUMENT_NODE));
    NodeFunction->asESObject()->defineDataProperty(
        escargot::ESString::create("DOCUMENT_TYPE_NODE"), false, true, false,
        escargot::ESValue(Node::DOCUMENT_TYPE_NODE));
    NodeFunction->asESObject()->defineDataProperty(
        escargot::ESString::create("DOCUMENT_FRAGMENT_NODE"), false, true,
        false, escargot::ESValue(Node::DOCUMENT_FRAGMENT_NODE));
    NodeFunction->asESObject()->defineDataProperty(
        escargot::ESString::create("NOTATION_NODE"), false, true, false,
        escargot::ESValue(Node::NOTATION_NODE));
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        ...
        escargot::ESString::create("nodeType"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        NodeFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("nodeName"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::NodeObject,
                                         Node);
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        NodeFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("ownerDocument"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::NodeObject,
                                         Node);
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        NodeFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("parentNode"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::NodeObject,
                                         Node);
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        NodeFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("parentElement"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::NodeObject,
                                         Node);
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        NodeFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("childNodes"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::NodeObject,
                                         Node);
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        NodeFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("nextSibling"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::NodeObject,
                                         Node);
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        NodeFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("previousSibling"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::NodeObject,
                                         Node);
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        NodeFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("firstChild"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::NodeObject,
                                         Node);
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        NodeFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("lastChild"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::NodeObject,
                                         Node);
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        NodeFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("nodeValue"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::NodeObject,
                                         Node);
            Node* nd = originalObj;
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        NodeFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("textContent"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::NodeObject,
                                         Node);
            Node* nd = originalObj;
    ...
    NodeFunction->protoType().asESPointer()->asESObject()->defineDataProperty(
        escargot::ESString::create("cloneNode"), true, true, true,
        escargot::ESFunctionObject::create(
            nullptr,
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                escargot::ESValue thisValue =
    ...
    NodeFunction->protoType().asESPointer()->asESObject()->defineDataProperty(
        escargot::ESString::create("hasChildNodes"), true, true, true,
        escargot::ESFunctionObject::create(
            nullptr,
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                escargot::ESValue thisValue =
    ...
    NodeFunction->protoType().asESPointer()->asESObject()->defineDataProperty(
        escargot::ESString::create("isEqualNode"), true, true, true,
        escargot::ESFunctionObject::create(
            nullptr,
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                escargot::ESValue thisValue =
                ...
                Node* obj = (Node*)thisValue.asESPointer()
                                ->asESObject()
                                ->extraPointerData();
                Node* node = (Node*)argValue.asESPointer()
                                 ->asESObject()
                                 ->extraPointerData();
    ...
    NodeFunction->defineAccessorProperty(
        escargot::ESString::create("DOCUMENT_POSITION_DISCONNECTED"),
        [](::escargot::ESObject* obj, ::escargot::ESObject* originalObj,
           escargot::ESString* name) -> escargot::ESValue {
    ...
    NodeFunction->defineAccessorProperty(
        escargot::ESString::create("DOCUMENT_POSITION_PRECEDING"),
        [](::escargot::ESObject* obj, ::escargot::ESObject* originalObj,
           escargot::ESString* name) -> escargot::ESValue {
    ...
    NodeFunction->defineAccessorProperty(
        escargot::ESString::create("DOCUMENT_POSITION_FOLLOWING"),
        [](::escargot::ESObject* obj, ::escargot::ESObject* originalObj,
           escargot::ESString* name) -> escargot::ESValue {
    ...
    NodeFunction->defineAccessorProperty(
        escargot::ESString::create("DOCUMENT_POSITION_CONTAINS"),
        [](::escargot::ESObject* obj, ::escargot::ESObject* originalObj,
           escargot::ESString* name) -> escargot::ESValue {
    ...
    NodeFunction->defineAccessorProperty(
        escargot::ESString::create("DOCUMENT_POSITION_CONTAINED_BY"),
        [](::escargot::ESObject* obj, ::escargot::ESObject* originalObj,
           escargot::ESString* name) -> escargot::ESValue {
    ...
    NodeFunction->defineAccessorProperty(
        escargot::ESString::create("DOCUMENT_POSITION_IMPLEMENTATION_SPECIFIC"),
        [](::escargot::ESObject* obj, ::escargot::ESObject* originalObj,
           escargot::ESString* name) -> escargot::ESValue {
            return escargot::ESValue(
    ...
    NodeFunction->protoType().asESPointer()->asESObject()->defineDataProperty(
        escargot::ESString::create("compareDocumentPosition"), true, true, true,
        escargot::ESFunctionObject::create(
            nullptr,
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                escargot::ESValue thisValue =
    ...
    NodeFunction->protoType().asESPointer()->asESObject()->defineDataProperty(
        escargot::ESString::create("contains"), true, true, true,
        escargot::ESFunctionObject::create(
            nullptr,
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                escargot::ESValue thisValue =
    ...
    escargot::ESFunctionObject* appendChildFunction =
        escargot::ESFunctionObject::create(
            nullptr,
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                try {
                    escargot::ESValue thisValue =
                        instance->currentExecutionContext()
                            ->resolveThisBinding();
                    CHECK_TYPEOF_WITH_ERRCODE(
                        thisValue, ScriptWrappable::Type::NodeObject, instance,
    ...
    NodeFunction->protoType().asESPointer()->asESObject()->defineDataProperty(
        escargot::ESString::create("appendChild"), true, true, true,
        appendChildFunction);

    NodeFunction->protoType().asESPointer()->asESObject()->defineDataProperty(
        escargot::ESString::create("removeChild"), true, true, true,
        escargot::ESFunctionObject::create(
            nullptr,
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                try {
    ...
    NodeFunction->protoType().asESPointer()->asESObject()->defineDataProperty(
        escargot::ESString::create("replaceChild"), true, true, true,
        escargot::ESFunctionObject::create(
            nullptr,
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                try {
    ...
    NodeFunction->protoType().asESPointer()->asESObject()->defineDataProperty(
        escargot::ESString::create("insertBefore"), true, true, true,
        escargot::ESFunctionObject::create(
            nullptr,
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                try {
...
escargot::ESFunctionObject* bindingElement(
    ScriptBindingInstance* scriptBindingInstance)
{
    DEFINE_FUNCTION_NOT_CONSTRUCTOR_WITH_PARENTFUNC(
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        ...
        escargot::ESString::create("firstElementChild"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::NodeObject,
                                         Node);
            return originalObj->firstElementChild()
                       ? originalObj->firstElementChild()->scriptValue()
                       : escargot::ESValue(escargot::ESValue::ESNull);
        },
        nullptr);

    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        ElementFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("lastElementChild"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::NodeObject,
                                         Node);
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        ElementFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("nextElementSibling"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::NodeObject,
                                         Node);
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        ElementFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("previousElementSibling"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::NodeObject,
                                         Node);
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        ElementFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("childElementCount"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::NodeObject,
                                         Node);
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        ElementFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("clientLeft"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::NodeObject,
                                         Node);
            if (originalObj->isElement()) {
                return escargot::ESValue(
                    originalObj->asElement()->clientLeft());
            }
            THROW_ILLEGAL_INVOCATION();
        },
        nullptr);
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        ElementFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("clientTop"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::NodeObject,
                                         Node);
            if (originalObj->isElement()) {
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        ElementFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("clientWidth"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::NodeObject,
                                         Node);
            if (originalObj->isElement()) {
                return escargot::ESValue(
                    originalObj->asElement()->clientWidth());
            }
            THROW_ILLEGAL_INVOCATION();
        },
        nullptr);
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        ElementFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("clientHeight"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::NodeObject,
                                         Node);
            if (originalObj->isElement()) {
                return escargot::ESValue(
                    originalObj->asElement()->clientHeight());
            }
            THROW_ILLEGAL_INVOCATION();
        },
        nullptr);
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        ElementFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("offsetParent"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::NodeObject,
                                         Node);
            if (originalObj->isElement()) {
    ...
    ElementFunction->protoType()
        ...
        ->asESObject()
        ->defineDataProperty(
            escargot::ESString::create("getClientRects"), true, true, true,
            escargot::ESFunctionObject::create(
                NULL,
                [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                    escargot::ESValue nd = instance->currentExecutionContext()
                                               ->resolveThisBinding();
                    CHECK_TYPEOF(nd, ScriptWrappable::Type::NodeObject);

                    Element* elem = ((Node*)nd.asESPointer()
                                         ->asESObject()
                                         ->extraPointerData())
                                        ->asElement();
    ...
    ElementFunction->protoType()
        ...
        ->asESObject()
        ->defineDataProperty(
            escargot::ESString::create("getBoundingClientRect"), true, true,
            true,
            escargot::ESFunctionObject::create(
                NULL,
                [](escargot::ESVMInstance* instance) -> escargot::ESValue {
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        ElementFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("localName"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::NodeObject,
                                         Node);
            Node* nd = originalObj;
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        ElementFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("tagName"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::NodeObject,
                                         Node);
            Node* nd = originalObj;
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        ElementFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("namespaceURI"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::NodeObject,
                                         Node);
            Node* nd = originalObj;
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        ElementFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("className"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::NodeObject,
                                         Node);
            Node* nd = originalObj;
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        ElementFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("children"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::NodeObject,
                                         Node);
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        ElementFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("classList"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::NodeObject,
                                         Node);
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        ElementFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("innerHTML"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::NodeObject,
                                         Node);
            Node* nd = originalObj;
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        ElementFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("attributes"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::NodeObject,
                                         Node);
    ...
    escargot::ESFunctionObject* removeFunction =
        escargot::ESFunctionObject::create(
            NULL,
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                escargot::ESValue thisValue =
    ...
    ElementFunction->protoType()
        .asESPointer()
        ->asESObject()
        ->defineDataProperty(escargot::ESString::create("remove"), false, false,
                             false, removeFunction);

    escargot::ESFunctionObject* getAttributeFunction =
        escargot::ESFunctionObject::create(
            NULL,
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                try {
    ...
    ElementFunction->protoType()
        .asESPointer()
        ->asESObject()
        ->defineDataProperty(escargot::ESString::create("getAttribute"), false,
                             false, false, getAttributeFunction);

    ElementFunction->protoType()
        .asESPointer()
        ->asESObject()
        ->defineDataProperty(
            escargot::ESString::create("setAttribute"), false, false, false,
            escargot::ESFunctionObject::create(
                NULL,
                [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                    try {
                        ...
                        escargot::ESValue key =
                            instance->currentExecutionContext()->readArgument(
                                0);
                        escargot::ESValue val =
                            instance->currentExecutionContext()->readArgument(
                                1);

                        if (key.isESString()) {
                            auto sf = ((Window*)instance->globalObject()
                                           ->extraPointerData())
                                          ->starFish();
                            // Validate key string
    ...
    ElementFunction->protoType()
        ...
        ->asESObject()
        ->defineDataProperty(
            escargot::ESString::create("removeAttribute"), false, false, false,
            escargot::ESFunctionObject::create(
                NULL,
                [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                    try {
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        ElementFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("style"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::NodeObject,
                                         Node);
            if (!originalObj->isElement()) {
    ...
    ElementFunction->protoType()
        ...
        ->asESObject()
        ->defineDataProperty(
            escargot::ESString::create("getElementsByClassName"), false, false,
            false,
            escargot::ESFunctionObject::create(
                NULL,
                [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                        ...
                        if (argValue.isESString() ||
                            ...
                            for (unsigned i = 0; i < array->length(); i++) {
                                ...
                                if (val.isESString()) {
                                    ...
                                    return escargot::ESValue(
                                        escargot::ESValue::ESNull);
                                }
                            }
                            HTMLCollection* result =
                                elem->getElementsByClassName(listSoFar);
                            if (result) {
                                return result->scriptValue();
                            }
                        }
                ...
                escargot::ESString::create("getElementsByClassName"), 1,
                false));
    ...
    ElementFunction->protoType()
        ...
        ->asESObject()
        ->defineDataProperty(
            escargot::ESString::create("getElementsByTagName"), false, false,
            false,
            escargot::ESFunctionObject::create(
                NULL,
                [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                    ...
                    if (obj->isElement()) {
                        ...
                        if (argValue.isESString()) {
                            ...
                            HTMLCollection* result = elem->getElementsByTagName(
                                elem->document()->createAttributeName(
                                    toBrowserString(argStr)));
                            if (result) {
                                return result->scriptValue();
                            }
    ...
    ElementFunction->protoType()
        ...
        ->asESObject()
        ->defineDataProperty(
            escargot::ESString::create("querySelector"), false, false, false,
            escargot::ESFunctionObject::create(
                NULL,
                [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                    escargot::ESValue thisValue =
                        ...
                        if (instance->currentExecutionContext()
                            ...
                            if (argValue.isESString()) {
                                try {
                                    ...
                                    Element* result = elem->querySelector(
                                        toBrowserString(argStr));
                                    if (result != nullptr) {
                                        return result->scriptValue();
                                    }
                                    ...
                                    escargot::ESVMInstance::currentInstance()
                                        ->throwError(e->scriptValue());
                                }
                            } else if (argValue.isNull() ||
                                       argValue.isUndefined()) {
                                return escargot::ESValue(
                                    escargot::ESValue::ESNull);
                            }
                        } else {
                            auto msg = escargot::ESString::create(
                                ...
                                "present.");
                            instance->throwError(escargot::ESValue(
                                escargot::TypeError::create(msg)));
                        }
#ifdef STARFISH_TC_COVERAGE
    ...
    ElementFunction->protoType()
        ...
        ->asESObject()
        ->defineDataProperty(
            escargot::ESString::create("querySelectorAll"), false, false, false,
            escargot::ESFunctionObject::create(
                NULL,
                [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                    escargot::ESValue thisValue =
                        ...
                        if (instance->currentExecutionContext()
                            ...
                            if (argValue.isESString()) {
                                try {
                                    ...
                                    NodeList* result = elem->querySelectorAll(
                                        toBrowserString(argStr));
                                    if (result != nullptr) {
                                        return result->scriptValue();
                                    }
    ...
    ElementFunction->protoType()
        ...
        ->asESObject()
        ->defineDataProperty(
            escargot::ESString::create("hasAttribute"), false, false, false,
            escargot::ESFunctionObject::create(
                NULL,
                [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                    escargot::ESValue thisValue =
                    ...
                    if (count == 1) {
                        ...
                        if (argValue.isESString()) {
                            ...
                            size_t res = ((Element*)thisValue.asESPointer()
                                              ...
                                              ->extraPointerData())
                                             ->hasAttribute(name);
                            return res != SIZE_MAX ? escargot::ESValue(true)
                                                   : escargot::ESValue(false);
                        } else {
                            return escargot::ESValue(false);
                        }
                    } else {
...
escargot::ESFunctionObject* bindingCharacterData(
    ScriptBindingInstance* scriptBindingInstance)
{
    DEFINE_FUNCTION_NOT_CONSTRUCTOR_WITH_PARENTFUNC(
            ...
            if (nd->isCharacterData()) {
                if (v.isNull()) {
                    nd->asCharacterData()->setData(
                        toBrowserString(::escargot::ESString::create("")));
                    return escargot::ESValue();
                } else if (v.isUndefined()) {
                    nd->asCharacterData()->setData(toBrowserString(
                        ::escargot::ESString::create("undefined")));
                    return escargot::ESValue();
                }
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        CharacterDataFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("length"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::NodeObject,
                                         Node);
            Node* nd = originalObj;
            if (nd->isCharacterData()) {
                if (nd->asCharacterData()->data()->isASCIIString()) {
                    ...
                    return escargot::ESValue(
                        toJSString(nd->asCharacterData()->data())
                            .toString()
                            ->length());
                }
            }
...
escargot::ESFunctionObject* bindingText(
    ScriptBindingInstance* scriptBindingInstance)
{
    /* 4.10 Interface Text */
    auto TextFunction = escargot::ESFunctionObject::create(
        NULL,
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            int argCount = instance->currentExecutionContext()->argumentCount();
            escargot::ESValue firstArg =
    ...
    TextFunction->defineAccessorProperty(
        escargot::ESVMInstance::currentInstance()->strings().prototype.string(),
        escargot::ESVMInstance::currentInstance()
            ->functionPrototypeAccessorData(),
        false, false, false);
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        ...
        escargot::ESString::create("wholeText"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::NodeObject,
                                         Node);
            Node* nd = originalObj;
...
escargot::ESFunctionObject* bindingComment(
    ScriptBindingInstance* scriptBindingInstance)
{
    /* 4.10 Interface Comment */
    auto CommentFunction = escargot::ESFunctionObject::create(
        NULL,
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            int argCount = instance->currentExecutionContext()->argumentCount();
            escargot::ESValue firstArg =
...
#ifdef STARFISH_ENABLE_MULTIMEDIA
escargot::ESFunctionObject* bindingTextTrack(
    ScriptBindingInstance* scriptBindingInstance)
{
    DEFINE_FUNCTION_NOT_CONSTRUCTOR_WITH_PARENTFUNC(
    ...
    TextTrackFunction->protoType()
        ...
        ->asESObject()
        ->defineDataProperty(
            escargot::ESString::create("addCue"), false, false, false,
            escargot::ESFunctionObject::create(
                NULL,
                [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                    escargot::ESValue thisValue =
                    ...
                    CHECK_TYPEOF(thisValue,
                                 ScriptWrappable::Type::TextTrackObject);
                    CHECK_TYPEOF(firstArg,
                                 ScriptWrappable::Type::TextTrackCueObject);

                    TextTrack* textTrack = (TextTrack*)thisValue.asESPointer()
                                               ->asESObject()
                                               ->extraPointerData();
                    TextTrackCue* cue = (TextTrackCue*)firstArg.asESPointer()
                                            ->asESObject()
                                            ->extraPointerData();
    ...
    TextTrackFunction->protoType()
        ...
        ->asESObject()
        ->defineDataProperty(
            escargot::ESString::create("removeCue"), false, false, false,
            escargot::ESFunctionObject::create(
                NULL,
                [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                    escargot::ESValue thisValue =
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        ...
        escargot::ESString::create("oncuechange"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        TextTrackFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("activeCues"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::TextTrackObject,
                                         TextTrack);
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        TextTrackFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("label"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::TextTrackObject,
                                         TextTrack);
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        TextTrackFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("language"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::TextTrackObject,
                                         TextTrack);
...
escargot::ESFunctionObject* bindingTextTrackList(
    ScriptBindingInstance* scriptBindingInstance)
{
    DEFINE_FUNCTION_NOT_CONSTRUCTOR_WITH_PARENTFUNC(
    ...
    TextTrackListFunction->protoType()
        ...
        ->asESObject()
        ->defineDataProperty(
            escargot::ESString::create("getTrackById"), true, true, true,
            escargot::ESFunctionObject::create(
                NULL,
                [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                    GENERATE_THIS_AND_CHECK_TYPE(
...
escargot::ESFunctionObject* bindingTextTrackCue(
    ScriptBindingInstance* scriptBindingInstance)
{
    DEFINE_FUNCTION_NOT_CONSTRUCTOR_WITH_PARENTFUNC(
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        ...
        escargot::ESString::create("startTime"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(
                ScriptWrappable::Type::TextTrackCueObject, TextTrackCue);
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        TextTrackCueFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("endTime"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(
                ScriptWrappable::Type::TextTrackCueObject, TextTrackCue);
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        TextTrackCueFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("track"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(
                ScriptWrappable::Type::TextTrackCueObject, TextTrackCue);
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        TextTrackCueFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("onenter"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(
                ScriptWrappable::Type::TextTrackCueObject, TextTrackCue);
            auto eventname =
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        TextTrackCueFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("onexit"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(
                ScriptWrappable::Type::TextTrackCueObject, TextTrackCue);
            auto eventname =
...
escargot::ESFunctionObject* bindingTextTrackCueList(
    ScriptBindingInstance* scriptBindingInstance)
{
...
escargot::ESFunctionObject* bindingVTTCue(
    ScriptBindingInstance* scriptBindingInstance)
{
    auto VTTCueFunction = escargot::ESFunctionObject::create(
        NULL,
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            int argCount = instance->currentExecutionContext()->argumentCount();
            if (argCount < 3) {
    ...
    VTTCueFunction->set__proto__(
        fetchData(scriptBindingInstance)->textTrackCue());

    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        VTTCueFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("text"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(
                ScriptWrappable::Type::TextTrackCueObject, TextTrackCue);
    ...
    VTTCueFunction->protoType().asESPointer()->asESObject()->defineDataProperty(
        escargot::ESString::create("getCueAsHTML"), true, true, true,
        escargot::ESFunctionObject::create(
            NULL,
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                GENERATE_THIS_AND_CHECK_TYPE(
...
escargot::ESFunctionObject* bindingTimeRanges(
    ScriptBindingInstance* scriptBindingInstance)
{
    ...
    TimeRangesFunction->protoType()
        ...
        ->asESObject()
        ->defineDataProperty(
            escargot::ESString::create("start"), true, true, true,
            escargot::ESFunctionObject::create(
                NULL,
                [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                    GENERATE_THIS_AND_CHECK_TYPE(
                        ScriptWrappable::Type::TimeRangesObject, TimeRanges);
                    escargot::ESValue firstArg =
                        instance->currentExecutionContext()->readArgument(0);
    ...
    TimeRangesFunction->protoType()
        ...
        ->asESObject()
        ->defineDataProperty(
            escargot::ESString::create("end"), true, true, true,
            escargot::ESFunctionObject::create(
                NULL,
                [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                    GENERATE_THIS_AND_CHECK_TYPE(
...
escargot::ESFunctionObject* bindingMediaSource(
    ScriptBindingInstance* scriptBindingInstance)
{
    // DEFINE_FUNCTION_NOT_CONSTRUCTOR_WITH_PARENTFUNC(MediaSource,
    // fetchData(scriptBindingInstance)->m_eventTarget);

    auto MediaSourceFunction = escargot::ESFunctionObject::create(
        NULL,
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            Window* w = ((Window*)escargot::ESVMInstance::currentInstance()
                             ->globalObject()
                             ->extraPointerData());
    ...
    MediaSourceFunction->defineAccessorProperty(
        ...
        escargot::ESVMInstance::currentInstance()
            ->functionPrototypeAccessorData(),
        false, false, false);
    MediaSourceFunction->protoType()
        .asESPointer()
        ->asESObject()
        ->forceNonVectorHiddenClass(false);
    MediaSourceFunction->protoType().asESPointer()->asESObject()->set__proto__(
    ...
    MediaSourceFunction->protoType()
        ...
        ->asESObject()
        ->defineDataProperty(
            escargot::ESString::create("addSourceBuffer"), true, true, true,
            escargot::ESFunctionObject::create(
                NULL,
                [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                    GENERATE_THIS_AND_CHECK_TYPE(
                        ScriptWrappable::Type::MediaSourceObject, MediaSource);
                    escargot::ESValue firstArg =
                        instance->currentExecutionContext()->readArgument(0);
    ...
    MediaSourceFunction->protoType()
        ...
        ->asESObject()
        ->defineDataProperty(
            escargot::ESString::create("removeSourceBuffer"), true, true, true,
            escargot::ESFunctionObject::create(
                NULL,
                [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                    GENERATE_THIS_AND_CHECK_TYPE(
                    ...
                    escargot::ESValue firstArg =
                        instance->currentExecutionContext()->readArgument(0);
                    CHECK_TYPEOF(firstArg,
                                 ScriptWrappable::Type::SourceBufferObject);

                    try {
                        MediaSource* mediaSource = (MediaSource*)originalObj;
                        SourceBuffer* sourceBuffer =
                            (SourceBuffer*)firstArg.asESPointer()
                                ->asESObject()
                                ->extraPointerData();
    ...
    MediaSourceFunction->protoType()
        ...
        ->asESObject()
        ->defineDataProperty(
            escargot::ESString::create("endOfStream"), true, true, true,
            escargot::ESFunctionObject::create(
                NULL,
                [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                    escargot::ESValue thisValue =
                    ...
                    MediaSource* mediaSource =
                        (MediaSource*)thisValue.asESPointer()
                            ->asESObject()
                            ->extraPointerData();
                    escargot::ESValue firstArg =
                        instance->currentExecutionContext()->readArgument(0);
    ...
    MediaSourceFunction->defineDataProperty(
        escargot::ESString::create("isTypeSupported"), true, true, true,
        escargot::ESFunctionObject::create(
            NULL,
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                escargot::ESValue firstArg =
                ...
                if (res) {
                    return escargot::ESValue(
                        escargot::ESValue::ESTrueTag::ESTrue);
                } else {
                    return escargot::ESValue(
                        escargot::ESValue::ESFalseTag::ESFalse);
                }
            },
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        ...
        escargot::ESString::create("sourceBuffers"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(
                ScriptWrappable::Type::MediaSourceObject, MediaSource);
            return escargot::ESValue(
                originalObj->sourceBuffers()->scriptValue());
        },
        nullptr);

    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        MediaSourceFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("activeSourceBuffers"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(
                ScriptWrappable::Type::MediaSourceObject, MediaSource);
            return escargot::ESValue(
                originalObj->activeSourceBuffers()->scriptValue());
        },
        nullptr);

    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        MediaSourceFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("readyState"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(
                ScriptWrappable::Type::MediaSourceObject, MediaSource);
            ...
            if (readyState == MediaSource::Open) {
                return toJSString(originalObj->starFish()
                                      ->staticStrings()
                                      ->m_open.localName());
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        MediaSourceFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("duration"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(
                ScriptWrappable::Type::MediaSourceObject, MediaSource);
...
escargot::ESFunctionObject* bindingSourceBuffer(
    ScriptBindingInstance* scriptBindingInstance)
{
    DEFINE_FUNCTION_NOT_CONSTRUCTOR_WITH_PARENTFUNC(
    ...
    SourceBufferFunction->protoType()
        ...
        ->asESObject()
        ->defineDataProperty(
            escargot::ESString::create("appendBuffer"), true, true, true,
            escargot::ESFunctionObject::create(
                NULL,
                [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                    escargot::ESValue thisValue =
                    ...
                    CHECK_TYPEOF(thisValue,
                                 ScriptWrappable::Type::SourceBufferObject);
                    SourceBuffer* sourceBuffer =
                        (SourceBuffer*)thisValue.asESPointer()
                            ->asESObject()
                            ->extraPointerData();
                    escargot::ESValue firstArg =
                        instance->currentExecutionContext()->readArgument(0);
                    ...
                    try {
                        if (false) {
                                 ...
                                 firstArg.asESPointer()
                                     ->isESArrayBufferObject()) {
                            escargot::ESArrayBufferObject* v =
                                firstArg.asESPointer()->asESArrayBufferObject();
                            sourceBuffer->appendBuffer((uint8_t*)v->data(),
                                                       v->bytelength());
                        } else if (firstArg.isESPointer() &&
                                   firstArg.asESPointer()
                                       ->isESArrayBufferView()) {
                            escargot::ESArrayBufferView* v =
                            ...
                            escargot::ESVMInstance::currentInstance()
                                ->throwError(escargot::ESValue(
                                    escargot::TypeError::create(
                                        escargot::ESString::create(
    ...
    SourceBufferFunction->protoType()
        ...
        ->asESObject()
        ->defineDataProperty(
            escargot::ESString::create("remove"), true, true, true,
            escargot::ESFunctionObject::create(
                NULL,
                [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                    escargot::ESValue thisValue =
                    ...
                    SourceBuffer* sourceBuffer =
                        (SourceBuffer*)thisValue.asESPointer()
                            ->asESObject()
                            ->extraPointerData();
                    escargot::ESValue arg0 =
                        instance->currentExecutionContext()->readArgument(0);
                    escargot::ESValue arg1 =
                        instance->currentExecutionContext()->readArgument(1);
    ...
    SourceBufferFunction->protoType()
        ...
        ->asESObject()
        ->defineDataProperty(
            escargot::ESString::create("abort"), true, true, true,
            escargot::ESFunctionObject::create(
                NULL,
                [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                    escargot::ESValue thisValue =
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        SourceBufferFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("updating"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(
                ScriptWrappable::Type::SourceBufferObject, SourceBuffer);
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        SourceBufferFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("buffered"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            try {
                GENERATE_THIS_AND_CHECK_TYPE(
                    ScriptWrappable::Type::SourceBufferObject, SourceBuffer);
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        SourceBufferFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("timestampOffset"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(
                ScriptWrappable::Type::SourceBufferObject, SourceBuffer);
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        SourceBufferFunction->protoType().asESPointer()->asESObject(),
    escargot::ESString::create("audioTracks"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        SourceBufferFunction->protoType().asESPointer()->asESObject(),
    escargot::ESString::create("videoTracks"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
        GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::SourceBufferObject,
    SourceBuffer);
    ...
    */
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        SourceBufferFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("textTracks"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(
                ScriptWrappable::Type::SourceBufferObject, SourceBuffer);
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        SourceBufferFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("appendWindowStart"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(
                ScriptWrappable::Type::SourceBufferObject, SourceBuffer);
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        SourceBufferFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("appendWindowEnd"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(
                ScriptWrappable::Type::SourceBufferObject, SourceBuffer);
...
#define DEFINE_SOURCEBUFFER_EVENT_HANDLER(eventName)                          \
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(                  \
        SourceBufferFunction->protoType().asESPointer()->asESObject(),        \
        escargot::ESString::create("on" #eventName),                          \
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {           \
            GENERATE_THIS_AND_CHECK_TYPE(                                     \
                ScriptWrappable::Type::SourceBufferObject, SourceBuffer);     \
            auto eventname =                                                  \
...
escargot::ESFunctionObject* bindingSourceBufferList(
    ScriptBindingInstance* scriptBindingInstance)
{
    DEFINE_FUNCTION_NOT_CONSTRUCTOR_WITH_PARENTFUNC(
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        SourceBufferListFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("SourceBuffer"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(
                ScriptWrappable::Type::SourceBufferListObject,
                SourceBufferList);
...
#if defined(STARFISH_TIZEN_TV) && defined(STARFISH_ENABLE_AVPLAY)
escargot::ESFunctionObject* bindingwebapis(
    ScriptBindingInstance* scriptBindingInstance)
{
...
escargot::ESFunctionObject* bindingavplay(
    ScriptBindingInstance* scriptBindingInstance)
{
    ...
    avplayFunction->protoType().asESPointer()->asESObject()->defineDataProperty(
        escargot::ESString::create("open"), true, true, true,
        escargot::ESFunctionObject::create(
            NULL,
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                GENERATE_THIS_AND_CHECK_TYPE(
    ...
    avplayFunction->protoType().asESPointer()->asESObject()->defineDataProperty(
        escargot::ESString::create("prepare"), true, true, true,
        escargot::ESFunctionObject::create(
            NULL,
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                GENERATE_THIS_AND_CHECK_TYPE(
    ...
    avplayFunction->protoType().asESPointer()->asESObject()->defineDataProperty(
        escargot::ESString::create("setDisplayRect"), true, true, true,
        escargot::ESFunctionObject::create(
            NULL,
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                GENERATE_THIS_AND_CHECK_TYPE(
                ...
                escargot::ESValue Arg2 =
                    instance->currentExecutionContext()->readArgument(1);
                escargot::ESValue Arg3 =
                    instance->currentExecutionContext()->readArgument(2);
                escargot::ESValue Arg4 =
    ...
    // webapis.avplay.play();
    avplayFunction->protoType().asESPointer()->asESObject()->defineDataProperty(
        escargot::ESString::create("play"), true, true, true,
        escargot::ESFunctionObject::create(
            NULL,
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                GENERATE_THIS_AND_CHECK_TYPE(
    ...
    avplayFunction->protoType().asESPointer()->asESObject()->defineDataProperty(
        escargot::ESString::create("close"), true, true, true,
        escargot::ESFunctionObject::create(
            NULL,
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                GENERATE_THIS_AND_CHECK_TYPE(
    ...
    avplayFunction->protoType().asESPointer()->asESObject()->defineDataProperty(
        escargot::ESString::create("pause"), true, true, true,
        escargot::ESFunctionObject::create(
            NULL,
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                GENERATE_THIS_AND_CHECK_TYPE(
    ...
    // webapis.avplay.stop();
    avplayFunction->protoType().asESPointer()->asESObject()->defineDataProperty(
        escargot::ESString::create("stop"), true, true, true,
        escargot::ESFunctionObject::create(
            NULL,
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                GENERATE_THIS_AND_CHECK_TYPE(
    ...
    avplayFunction->protoType().asESPointer()->asESObject()->defineDataProperty(
        escargot::ESString::create("suspend"), true, true, true,
        escargot::ESFunctionObject::create(
            NULL,
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                GENERATE_THIS_AND_CHECK_TYPE(
    ...
    avplayFunction->protoType().asESPointer()->asESObject()->defineDataProperty(
        escargot::ESString::create("restore"), true, true, true,
        escargot::ESFunctionObject::create(
            NULL,
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                GENERATE_THIS_AND_CHECK_TYPE(
    ...
    avplayFunction->protoType().asESPointer()->asESObject()->defineDataProperty(
        escargot::ESString::create("getState"), true, true, true,
        escargot::ESFunctionObject::create(
            NULL,
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                GENERATE_THIS_AND_CHECK_TYPE(
    ...
    avplayFunction->protoType().asESPointer()->asESObject()->defineDataProperty(
        escargot::ESString::create("getCurrentTime"), true, true, true,
        escargot::ESFunctionObject::create(
            NULL,
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                GENERATE_THIS_AND_CHECK_TYPE(
    ...
    avplayFunction->protoType().asESPointer()->asESObject()->defineDataProperty(
        escargot::ESString::create("getDuration"), true, true, true,
        escargot::ESFunctionObject::create(
            NULL,
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                GENERATE_THIS_AND_CHECK_TYPE(
    ...
    avplayFunction->protoType().asESPointer()->asESObject()->defineDataProperty(
        escargot::ESString::create("setStreamingProperty"), true, true, true,
        escargot::ESFunctionObject::create(
            NULL,
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                GENERATE_THIS_AND_CHECK_TYPE(
    ...
    avplayFunction->protoType().asESPointer()->asESObject()->defineDataProperty(
        escargot::ESString::create("prepareAsync"), true, true, true,
        escargot::ESFunctionObject::create(
            NULL,
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                GENERATE_THIS_AND_CHECK_TYPE(
    ...
    avplayFunction->protoType().asESPointer()->asESObject()->defineDataProperty(
        escargot::ESString::create("setListener"), true, true, true,
        escargot::ESFunctionObject::create(
            NULL,
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                GENERATE_THIS_AND_CHECK_TYPE(
    ...
    avplayFunction->protoType().asESPointer()->asESObject()->defineDataProperty(
        escargot::ESString::create("seekTo"), true, true, true,
        escargot::ESFunctionObject::create(
            NULL,
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                GENERATE_THIS_AND_CHECK_TYPE(
...
escargot::ESFunctionObject* bindingDocumentFragment(
    ScriptBindingInstance* scriptBindingInstance)
{
    DEFINE_FUNCTION_NOT_CONSTRUCTOR_WITH_PARENTFUNC(
...
escargot::ESFunctionObject* bindingDocumentType(
    ScriptBindingInstance* scriptBindingInstance)
{
    DEFINE_FUNCTION_NOT_CONSTRUCTOR_WITH_PARENTFUNC(
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        DocumentTypeFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("publicId"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::NodeObject,
                                         Node);
            Node* nd = originalObj;
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        DocumentTypeFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("systemId"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::NodeObject,
                                         Node);
            Node* nd = originalObj;
...
escargot::ESFunctionObject* bindingDocument(
    ScriptBindingInstance* scriptBindingInstance)
{
    DEFINE_FUNCTION_NOT_CONSTRUCTOR_WITH_PARENTFUNC(
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        DocumentFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("documentElement"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::NodeObject,
                                         Node);
            Node* nd = originalObj;
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        DocumentFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("implementation"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::NodeObject,
                                         Node);
            Node* nd = originalObj;
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        DocumentFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("characterSet"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::NodeObject,
                                         Node);
            Node* nd = originalObj;
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        DocumentFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("charset"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::NodeObject,
                                         Node);
            Node* nd = originalObj;
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        DocumentFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("contentType"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::NodeObject,
                                         Node);
            Node* nd = originalObj;
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        DocumentFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("compatMode"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::NodeObject,
                                         Node);
            Node* nd = originalObj;
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        DocumentFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("documentURI"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::NodeObject,
                                         Node);
            Node* nd = originalObj;
    ...
    escargot::ESFunctionObject* getElementByIdFunction =
        escargot::ESFunctionObject::create(
            NULL,
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                escargot::ESValue thisValue =
                ...
                if (obj->isDocument()) {
                    ...
                    if (argValue.isESString()) {
                        ...
                        if (*argStr ==
                            *(escargot::strings->emptyString.string())) {
                            return escargot::ESValue(escargot::ESValue::ESNull);
                        }
                        ...
                        Element* elem = doc->getElementById(toBrowserString(
                            escargot::ESString::create("null")));
                        if (elem != nullptr) {
                            return elem->scriptValue();
                        }
                    } else if (argValue.isUndefined()) {
    ...
    DocumentFunction->protoType()
        .asESPointer()
        ->asESObject()
        ->defineDataProperty(escargot::ESString::create("getElementById"),
                             false, false, false, getElementByIdFunction);

    escargot::ESFunctionObject* querySelectorFunction =
        escargot::ESFunctionObject::create(
            NULL,
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                escargot::ESValue thisValue =
    ...
    DocumentFunction->protoType()
        .asESPointer()
        ->asESObject()
        ->defineDataProperty(escargot::ESString::create("querySelector"), false,
                             false, false, querySelectorFunction);

#ifdef STARFISH_ENABLE_WASU
    escargot::ESFunctionObject* querySelectorAllFunction =
        escargot::ESFunctionObject::create(
            NULL,
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                escargot::ESValue thisValue =
                    ...
                    if (instance->currentExecutionContext()->argumentCount() >
                        ...
                        if (argValue.isESString()) {
                            try {
                                ...
                                NodeList* list = doc->querySelectorAll(
                                    toBrowserString(argStr));
                                if (list != nullptr) {
                                    return list->scriptValue();
                                }
    ...
    DocumentFunction->protoType()
        .asESPointer()
        ->asESObject()
        ->defineDataProperty(escargot::ESString::create("querySelectorAll"),
                             false, false, false, querySelectorAllFunction);
#endif
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        DocumentFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("doctype"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::NodeObject,
                                         Node);
            Node* nd = originalObj;
    ...
    escargot::ESFunctionObject* createDocumentFragmentFunction =
        escargot::ESFunctionObject::create(
            NULL,
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                try {
    ...
    DocumentFunction->protoType()
        ...
        ->asESObject()
        ->defineDataProperty(
            escargot::ESString::create("createDocumentFragment"), false, false,
            false, createDocumentFragmentFunction);

    escargot::ESFunctionObject* createElementFunction =
        escargot::ESFunctionObject::create(
            NULL,
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                try {
    ...
    DocumentFunction->protoType()
        .asESPointer()
        ->asESObject()
        ->defineDataProperty(escargot::ESString::create("createElement"), false,
                             false, false, createElementFunction);

    escargot::ESFunctionObject* createTextNodeFunction =
        escargot::ESFunctionObject::create(
            NULL,
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                escargot::ESValue thisValue =
                ...
                if (obj->isDocument()) {
                    ...
                    if (argValue.isESString()) {
                        escargot::ESString* argStr = argValue.asESString();
                        Text* elem =
                            doc->createTextNode(toBrowserString(argStr));
                        if (elem != nullptr) {
                            return elem->scriptValue();
                        }
                    } else if (argValue.isNull()) {
                        Text* elem = doc->createTextNode(toBrowserString(
                            escargot::ESString::create("null")));
                        if (elem != nullptr) {
                            return elem->scriptValue();
                        }
    ...
    DocumentFunction->protoType()
        .asESPointer()
        ->asESObject()
        ->defineDataProperty(escargot::ESString::create("createTextNode"),
                             false, false, false, createTextNodeFunction);

    escargot::ESFunctionObject* createCommentNodeFunction =
        escargot::ESFunctionObject::create(
            NULL,
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                escargot::ESValue thisValue =
                ...
                if (obj->isDocument()) {
                    ...
                    if (argValue.isUndefined()) {
                        elem =
                            doc->createComment(String::fromUTF8("undefined"));
                    } else if (argValue.isNull()) {
    ...
    DocumentFunction->protoType()
        .asESPointer()
        ->asESObject()
        ->defineDataProperty(escargot::ESString::create("createComment"), false,
                             false, false, createCommentNodeFunction);

    escargot::ESFunctionObject* getElementsByTagNameFunction =
        escargot::ESFunctionObject::create(
            NULL,
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                escargot::ESValue thisValue =
    ...
    DocumentFunction->protoType()
        .asESPointer()
        ->asESObject()
        ->defineDataProperty(escargot::ESString::create("getElementsByTagName"),
                             false, false, false, getElementsByTagNameFunction);

    escargot::ESFunctionObject* getElementsByClassNameFunction =
        escargot::ESFunctionObject::create(
            NULL,
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                escargot::ESValue thisValue =
                ...
                if (obj->isDocument()) {
                    ...
                    if (argValue.isESString() || argValue.isUndefinedOrNull()) {
                        ...
                        HTMLCollection* result = doc->getElementsByClassName(
                            toBrowserString(argStr));
                        if (result != nullptr) {
                            return result->scriptValue();
                        }
    ...
    DocumentFunction->protoType()
        ...
        ->defineDataProperty(
            escargot::ESString::create("getElementsByClassName"), false, false,
            false, getElementsByClassNameFunction);

    escargot::ESFunctionObject* createAttributeFunction =
        escargot::ESFunctionObject::create(
            NULL,
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                try {
    ...
    DocumentFunction->protoType()
        .asESPointer()
        ->asESObject()
        ->defineDataProperty(escargot::ESString::create("createAttribute"),
                             false, false, false, createAttributeFunction);
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        DocumentFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("hidden"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::NodeObject,
                                         Node);
            if (originalObj->isDocument()) {
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        DocumentFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("visibilityState"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::NodeObject,
                                         Node);
            if (originalObj->isDocument()) {
    ...
    escargot::ESFunctionObject* elementFromPointFunction =
        escargot::ESFunctionObject::create(
            NULL,
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                escargot::ESValue thisValue =
                ...
                if (obj->isDocument()) {
                    Document* doc = obj->asDocument();
                    escargot::ESValue argValue0 =
                        instance->currentExecutionContext()->readArgument(0);
                    escargot::ESValue argValue1 =
                        instance->currentExecutionContext()->readArgument(0);
                    Element* element = doc->elementFromPoint(
                        argValue0.toNumber(), argValue1.toNumber());
                    if (element) {
    ...
    DocumentFunction->protoType()
        .asESPointer()
        ->asESObject()
        ->defineDataProperty(escargot::ESString::create("elementFromPoint"),
                             false, false, false, elementFromPointFunction);
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        DocumentFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("defaultView"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::NodeObject,
                                         Node);
            Node* nd = originalObj;
...
escargot::ESFunctionObject* bindingHTMLElement(
    ScriptBindingInstance* scriptBindingInstance)
{
    DEFINE_FUNCTION_NOT_CONSTRUCTOR_WITH_PARENTFUNC(
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        HTMLElementFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("offsetWidth"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::NodeObject,
                                         Node);
            Node* nd = originalObj;
            if (nd->isElement() && nd->asElement()->isHTMLElement()) {
                return escargot::ESValue(
                    nd->asElement()->asHTMLElement()->offsetWidth());
            } else {
                THROW_ILLEGAL_INVOCATION();
            }
        },
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        HTMLElementFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("offsetHeight"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::NodeObject,
                                         Node);
            Node* nd = originalObj;
    ...
    escargot::ESFunctionObject* clickFunction =
        escargot::ESFunctionObject::create(
            NULL,
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::NodeObject,
    ...
    HTMLElementFunction->protoType()
        .asESPointer()
        ->asESObject()
        ->defineDataProperty(escargot::ESString::create("click"), true, true,
                             true, clickFunction);
    ...
    escargot::ESFunctionObject* mouseoverFunction =
        escargot::ESFunctionObject::create(
            NULL,
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::NodeObject,
    ...
    HTMLElementFunction->protoType()
        .asESPointer()
        ->asESObject()
        ->defineDataProperty(escargot::ESString::create("mouseover"), true,
                             true, true, mouseoverFunction);
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        HTMLElementFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("onkeyup"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::NodeObject,
                                         Node);
            Node* nd = originalObj;
    ...
    escargot::ESFunctionObject* focusFunction =
        escargot::ESFunctionObject::create(
            NULL,
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::NodeObject,
    ...
    HTMLElementFunction->protoType()
        .asESPointer()
        ->asESObject()
        ->defineDataProperty(escargot::ESString::create("focus"), true, true,
                             true, focusFunction);
...
escargot::ESFunctionObject* bindingHTMLBodyElement(
    ScriptBindingInstance* scriptBindingInstance)
{
    DEFINE_FUNCTION_NOT_CONSTRUCTOR_WITH_PARENTFUNC(
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        ...
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            ...
            if (nd->isElement() && nd->asElement()->isHTMLElement() &&
                ...
                auto element =
                    nd->asElement()->asHTMLElement()->asHTMLBodyElement();
                auto eventType = element->document()
                                     ->window()
                                     ->starFish()
                                     ->staticStrings()
                                     ->m_load;
                return element->document()->window()->attributeEventListener(
                    eventType);
            } else {
                THROW_ILLEGAL_INVOCATION();
            }
        ...
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            ...
            if (nd->isElement() && nd->asElement()->isHTMLElement() &&
                ...
                if (v.isObject() || (v.isESPointer() &&
                                     v.asESPointer()->isESFunctionObject())) {
                    element->document()->window()->setAttributeEventListener(
                        eventType, v);
                } else {
...
escargot::ESFunctionObject* bindingHTMLScriptElement(
    ScriptBindingInstance* scriptBindingInstance)
{
    DEFINE_FUNCTION_NOT_CONSTRUCTOR_WITH_PARENTFUNC(
...
escargot::ESFunctionObject* bindingHTMLStyleElement(
    ScriptBindingInstance* scriptBindingInstance)
{
    DEFINE_FUNCTION_NOT_CONSTRUCTOR_WITH_PARENTFUNC(
        HTMLStyleElement, fetchData(scriptBindingInstance)->htmlElement());
...
escargot::ESFunctionObject* bindingHTMLLinkElement(
    ScriptBindingInstance* scriptBindingInstance)
{
    DEFINE_FUNCTION_NOT_CONSTRUCTOR_WITH_PARENTFUNC(
...
escargot::ESFunctionObject* bindingHTMLImageElement(
    ScriptBindingInstance* scriptBindingInstance)
{
    DEFINE_FUNCTION_NOT_CONSTRUCTOR_WITH_PARENTFUNC(
        HTMLImageElement, fetchData(scriptBindingInstance)->htmlElement());
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        HTMLImageElementFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("width"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::NodeObject,
                                         Node);
            Node* nd = originalObj;
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        HTMLImageElementFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("height"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::NodeObject,
                                         Node);
            Node* nd = originalObj;
...
escargot::ESFunctionObject* bindingHTMLObjectElement(
    ScriptBindingInstance* scriptBindingInstance)
{
    DEFINE_FUNCTION_NOT_CONSTRUCTOR_WITH_PARENTFUNC(
...
#ifdef STARFISH_ENABLE_MULTI_PAGE
escargot::ESFunctionObject* bindingHTMLAnchorElement(
    ScriptBindingInstance* scriptBindingInstance)
{
    DEFINE_FUNCTION_NOT_CONSTRUCTOR_WITH_PARENTFUNC(
...
#define DEFINE_HTMLELEMENT_READ_WRITE_PROPERTY(ElementName, getter, setter, \
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(                \
        HTML##ElementName##ElementFunction->protoType()                     \
            .asESPointer()                                                  \
            ->asESObject(),                                                 \
        escargot::ESString::create(#getter),                                \
...
#define DEFINE_HTMLELEMENT_EVENT_PROPERTY(ElementName, getter, setter, TYPE_F) \
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(                   \
        HTML##ElementName##ElementFunction->protoType()                        \
            .asESPointer()                                                     \
            ->asESObject(),                                                    \
        escargot::ESString::create("on" #getter),                              \
        DEFINE_HTMLELEMENT_PROPERTY_GETTER(ElementName, getter, TYPE_F),       \
...
escargot::ESFunctionObject* bindingHTMLMediaElement(
    ScriptBindingInstance* scriptBindingInstance)
{
    DEFINE_FUNCTION_NOT_CONSTRUCTOR_WITH_PARENTFUNC(
    ...
    HTMLMediaElementFunction->asESObject()->defineDataProperty(
        escargot::ESString::create("NETWORK_EMPTY"), false, true, false,
        escargot::ESValue(HTMLMediaElement::NETWORK_EMPTY));
    HTMLMediaElementFunction->asESObject()->defineDataProperty(
        escargot::ESString::create("NETWORK_IDLE"), false, true, false,
        escargot::ESValue(HTMLMediaElement::NETWORK_IDLE));
    HTMLMediaElementFunction->asESObject()->defineDataProperty(
        escargot::ESString::create("NETWORK_LOADING"), false, true, false,
        escargot::ESValue(HTMLMediaElement::NETWORK_LOADING));
    HTMLMediaElementFunction->asESObject()->defineDataProperty(
        escargot::ESString::create("NETWORK_NO_SOURCE"), false, true, false,
        escargot::ESValue(HTMLMediaElement::NETWORK_NO_SOURCE));
    HTMLMediaElementFunction->asESObject()->defineDataProperty(
        escargot::ESString::create("HAVE_NOTHING"), false, true, false,
        escargot::ESValue(HTMLMediaElement::HAVE_NOTHING));
    HTMLMediaElementFunction->asESObject()->defineDataProperty(
        escargot::ESString::create("HAVE_METADATA"), false, true, false,
        escargot::ESValue(HTMLMediaElement::HAVE_METADATA));
    HTMLMediaElementFunction->asESObject()->defineDataProperty(
        escargot::ESString::create("HAVE_CURRENT_DATA"), false, true, false,
        escargot::ESValue(HTMLMediaElement::HAVE_CURRENT_DATA));
    HTMLMediaElementFunction->asESObject()->defineDataProperty(
        escargot::ESString::create("HAVE_FUTURE_DATA"), false, true, false,
        escargot::ESValue(HTMLMediaElement::HAVE_FUTURE_DATA));
    HTMLMediaElementFunction->asESObject()->defineDataProperty(
        escargot::ESString::create("HAVE_ENOUGH_DATA"), false, true, false,
        escargot::ESValue(HTMLMediaElement::HAVE_ENOUGH_DATA));
    ...
    HTMLMediaElementFunction->protoType()
        ...
        ->asESObject()
        ->defineDataProperty(
            escargot::ESString::create("addTextTrack"), true, true, true,
            escargot::ESFunctionObject::create(
                NULL,
                [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                    GENERATE_THIS_AND_CHECK_TYPE(
    ...
    HTMLMediaElementFunction->protoType()
        ...
        ->asESObject()
        ->defineDataProperty(
            escargot::ESString::create("load"), true, true, true,
            escargot::ESFunctionObject::create(
                NULL,
                [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                    GENERATE_THIS_AND_CHECK_TYPE(
    ...
    HTMLMediaElementFunction->protoType()
        ...
        ->asESObject()
        ->defineDataProperty(
            escargot::ESString::create("canPlayType"), true, true, true,
            escargot::ESFunctionObject::create(
                NULL,
                [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                    GENERATE_THIS_AND_CHECK_TYPE(
...
escargot::ESFunctionObject* bindingHTMLVideoElement(
    ScriptBindingInstance* scriptBindingInstance)
{
    DEFINE_FUNCTION_NOT_CONSTRUCTOR_WITH_PARENTFUNC(
...
escargot::ESFunctionObject* bindingHTMLAudioElement(
    ScriptBindingInstance* scriptBindingInstance)
{
    DEFINE_FUNCTION_NOT_CONSTRUCTOR_WITH_PARENTFUNC(
...
escargot::ESFunctionObject* bindingHTMLTrackElement(
    ScriptBindingInstance* scriptBindingInstance)
{
    DEFINE_FUNCTION_NOT_CONSTRUCTOR_WITH_PARENTFUNC(
    ...
    HTMLTrackElementFunction->asESObject()->defineDataProperty(
        escargot::ESString::create("NONE"), false, true, false,
        escargot::ESValue(HTMLTrackElement::NONE));
    HTMLTrackElementFunction->asESObject()->defineDataProperty(
        escargot::ESString::create("LOADING"), false, true, false,
        escargot::ESValue(HTMLTrackElement::LOADING));
    HTMLTrackElementFunction->asESObject()->defineDataProperty(
        escargot::ESString::create("LOADED"), false, true, false,
        escargot::ESValue(HTMLTrackElement::LOADED));
    HTMLTrackElementFunction->asESObject()->defineDataProperty(
        escargot::ESString::create("ERROR"), false, true, false,
        escargot::ESValue(HTMLTrackElement::ERROR));
...
escargot::ESFunctionObject* bindingHTMLSourceElement(
    ScriptBindingInstance* scriptBindingInstance)
{
    DEFINE_FUNCTION_NOT_CONSTRUCTOR_WITH_PARENTFUNC(
...
escargot::ESFunctionObject* bindingHTMLCollection(
    ScriptBindingInstance* scriptBindingInstance)
{
    ...
    escargot::ESFunctionObject* itemFunction =
        escargot::ESFunctionObject::create(
            NULL,
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                escargot::ESValue thisValue =
                ...
                HTMLCollection* self =
                    (HTMLCollection*)(thisValue.asESPointer()
                                          ->asESObject()
                                          ->extraPointerData());
    ...
    HTMLCollectionFunction->protoType()
        .asESPointer()
        ->asESObject()
        ->defineDataProperty(escargot::ESString::create("item"), true, true,
                             true, itemFunction);

    escargot::ESFunctionObject* namedItemFunction =
        escargot::ESFunctionObject::create(
            NULL,
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                escargot::ESValue thisValue =
    ...
    HTMLCollectionFunction->protoType()
        .asESPointer()
        ->asESObject()
        ->defineDataProperty(escargot::ESString::create("namedItem"), true,
                             true, true, namedItemFunction);

    return HTMLCollectionFunction;
}

escargot::ESFunctionObject* bindingEvent(
    ScriptBindingInstance* scriptBindingInstance)
{
    /* 3.2 Interface Event */
    auto eventFunction = escargot::ESFunctionObject::create(
        NULL,
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            int argCount = instance->currentExecutionContext()->argumentCount();
            escargot::ESValue firstArg =
            ...
            if (argCount == 0) {
                ...
                if (secondArg.isObject() || secondArg.isUndefinedOrNull()) {
                    ...
                    if (!secondArg.isUndefinedOrNull()) {
                        escargot::ESValue bubbles =
                            secondArg.asESPointer()->asESObject()->get(
                                escargot::ESString::create("bubbles"));
                        escargot::ESValue cancelable =
                            secondArg.asESPointer()->asESObject()->get(
                                escargot::ESString::create("cancelable"));
    ...
    // fetchData(scriptBindingInstance)->m_instance->globalObject()
    //                                 ->defineDataProperty
    //           (escargot::ESString::create("Event"), true, false,
    //           true, eventFunction);
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        eventFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("target"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::EventObject,
                                         Event);
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        eventFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("currentTarget"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::EventObject,
                                         Event);
    ...
    eventFunction->asESObject()->defineDataProperty(
        escargot::ESString::create("NONE"), false, true, false,
        escargot::ESValue(Event::NONE));
    eventFunction->asESObject()->defineDataProperty(
        escargot::ESString::create("CAPTURING_PHASE"), false, true, false,
        escargot::ESValue(Event::CAPTURING_PHASE));
    eventFunction->asESObject()->defineDataProperty(
        escargot::ESString::create("AT_TARGET"), false, true, false,
        escargot::ESValue(Event::AT_TARGET));
    eventFunction->asESObject()->defineDataProperty(
        escargot::ESString::create("BUBBLING_PHASE"), false, true, false,
        escargot::ESValue(Event::BUBBLING_PHASE));
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        eventFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("eventPhase"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::EventObject,
                                         Event);
    ...
    auto stopPropagationFunction = escargot::ESFunctionObject::create(
        NULL,
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            escargot::ESValue thisValue =
                instance->currentExecutionContext()->resolveThisBinding();
    ...
    eventFunction->protoType().asESPointer()->asESObject()->defineDataProperty(
        escargot::ESString::create("stopPropagation"), false, false, false,
        stopPropagationFunction);

    auto stopImmediatePropagationFunction = escargot::ESFunctionObject::create(
        NULL,
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            escargot::ESValue thisValue =
                instance->currentExecutionContext()->resolveThisBinding();
    ...
    eventFunction->protoType().asESPointer()->asESObject()->defineDataProperty(
        escargot::ESString::create("stopImmediatePropagation"), false, false,
        false, stopImmediatePropagationFunction);
    ...
    auto preventDefaultFunction = escargot::ESFunctionObject::create(
        NULL,
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            escargot::ESValue thisValue =
                instance->currentExecutionContext()->resolveThisBinding();
    ...
    eventFunction->protoType().asESPointer()->asESObject()->defineDataProperty(
        escargot::ESString::create("preventDefault"), false, false, false,
        preventDefaultFunction);

    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        eventFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("defaultPrevented"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::EventObject,
                                         Event);
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        eventFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("timeStamp"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::EventObject,
                                         Event);
...
escargot::ESFunctionObject* bindingUIEvent(
    ScriptBindingInstance* scriptBindingInstance)
{
    /* UI Events */
...
escargot::ESFunctionObject* bindingMouseEvent(
    ScriptBindingInstance* scriptBindingInstance)
{
    /* Mouse Events */
...
escargot::ESFunctionObject* bindingTouchEvent(
    ScriptBindingInstance* scriptBindingInstance)
{
    /* Touch Events */
    DEFINE_FUNCTION_WITH_PARENTFUNC(
...
escargot::ESFunctionObject* bindingKeyboardEvent(
    ScriptBindingInstance* scriptBindingInstance)
{
    /* Keyboard Events */
    DEFINE_FUNCTION_WITH_PARENTFUNC(
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        ...
        escargot::ESString::create("keyCode"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::EventObject,
                                         Event);
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        KeyboardEventFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("ctrlKey"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::EventObject,
                                         Event);
            if (originalObj->isUIEvent() &&
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        KeyboardEventFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("altKey"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::EventObject,
                                         Event);
            if (originalObj->isUIEvent() &&
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        KeyboardEventFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("shiftKey"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::EventObject,
                                         Event);
            if (originalObj->isUIEvent() &&
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        KeyboardEventFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("metaKey"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::EventObject,
                                         Event);
            if (originalObj->isUIEvent() &&
...
escargot::ESFunctionObject* bindingFocusEvent(
    ScriptBindingInstance* scriptBindingInstance)
{
    /* Focus Events */
    DEFINE_FUNCTION_WITH_PARENTFUNC(
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        ...
        escargot::ESString::create("relatedTarget"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::EventObject,
                                         Event);
            if (originalObj->isUIEvent() &&
...
escargot::ESFunctionObject* bindingProgressEvent(
    ScriptBindingInstance* scriptBindingInstance)
{
    /* Progress Events */
    auto progressEventFunction = escargot::ESFunctionObject::create(
        NULL,
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            int argCount = instance->currentExecutionContext()->argumentCount();
            escargot::ESValue firstArg =
            ...
            if (argCount == 0) {
                ...
                if (secondArg.isObject()) {
                    escargot::ESString* type = firstArg.toString();
                    escargot::ESObject* obj =
                        secondArg.asESPointer()->asESObject();
                    escargot::ESValue bubbles =
                        obj->get(escargot::ESString::create("bubbles"));
                    escargot::ESValue cancelable =
                        obj->get(escargot::ESString::create("cancelable"));
                    escargot::ESValue lengthComputable = obj->get(
                        escargot::ESString::create("lengthComputable"));
                    escargot::ESValue loaded =
                        obj->get(escargot::ESString::create("loaded"));
                    escargot::ESValue total =
                        obj->get(escargot::ESString::create("total"));
                    bool canBubbles =
                        bubbles.isBoolean() ? bubbles.asBoolean() : false;
                    bool canCancelable =
                    ...
                    if (lengthComputable.isBoolean()) {
                        ...
                        canLengthComputable =
                            lengthComputable.asESString()->length() != 0
                                ? true
                                : false;
                    }
...
#endif
                    auto event = new ProgressEvent(
                        String::fromUTF8(type->utf8Data()),
                        ProgressEventInit(canBubbles, canCancelable,
                                          canLengthComputable, loadedValue,
                                          totalValue));
                    return event->scriptValue();
                } else {
                    escargot::ESString* msg = escargot::ESString::create(
    ...
    progressEventFunction->protoType()
        .asESPointer()
        ->asESObject()
        ->set__proto__(fetchData(scriptBindingInstance)->event()->protoType());
    ...
    // fetchData(scriptBindingInstance)->m_instance->globalObject()
    //                                 ->defineDataProperty
    //           (escargot::ESString::create("ProgressEvent"), true, false,
        ...
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            ...
            if (e->isProgressEvent()) {
                bool lengthComputable =
                    e->asProgressEvent()->lengthComputable();
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        progressEventFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("loaded"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::EventObject,
                                         Event);
            Event* e = originalObj;
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        progressEventFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("total"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::EventObject,
                                         Event);
            Event* e = originalObj;
...
escargot::ESFunctionObject* bindingNodeList(
    ScriptBindingInstance* scriptBindingInstance)
{
    ...
    NodeListFunction->protoType()
        ...
        ->asESObject()
        ->defineDataProperty(
            escargot::ESString::create("item"), false, false, false,
            escargot::ESFunctionObject::create(
                NULL,
                [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                    escargot::ESValue thisValue =
...
escargot::ESFunctionObject* bindingDOMTokenList(
    ScriptBindingInstance* scriptBindingInstance)
{
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        ...
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(
                ScriptWrappable::Type::DOMTokenListObject, DOMTokenList);
            uint32_t len = originalObj->length();
            return escargot::ESValue(len);
        },
        nullptr);

    escargot::ESFunctionObject* domTokenListItemFunction =
        escargot::ESFunctionObject::create(
            NULL,
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                escargot::ESValue thisValue =
    ...
    DOMTokenListFunction->protoType()
        .asESPointer()
        ->asESObject()
        ->defineDataProperty(escargot::ESString::create("item"), false, false,
                             false, domTokenListItemFunction);

    escargot::ESFunctionObject* domTokenListContainsFunction =
        escargot::ESFunctionObject::create(
            NULL,
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                escargot::ESValue thisValue =
    ...
    DOMTokenListFunction->protoType()
        .asESPointer()
        ->asESObject()
        ->defineDataProperty(escargot::ESString::create("contains"), false,
                             false, false, domTokenListContainsFunction);

    escargot::ESFunctionObject* domTokenListAddFunction =
        escargot::ESFunctionObject::create(
            NULL,
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                escargot::ESValue thisValue =
    ...
    DOMTokenListFunction->protoType()
        .asESPointer()
        ->asESObject()
        ->defineDataProperty(escargot::ESString::create("add"), false, false,
                             false, domTokenListAddFunction);

    escargot::ESFunctionObject* domTokenListRemoveFunction =
        escargot::ESFunctionObject::create(
            NULL,
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                escargot::ESValue thisValue =
    ...
    DOMTokenListFunction->protoType()
        ...
        ->asESObject()
        ->defineDataProperty(escargot::ESString::create("remove"), false, false,
                             false, domTokenListRemoveFunction);

    escargot::ESFunctionObject* domTokenListToggleFunction =
        escargot::ESFunctionObject::create(
            NULL,
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                escargot::ESValue thisValue =
                            ...
                            if (forceValue.isUndefined()) {
                                didAdd =
                                    ((DOMTokenList*)thisValue.asESPointer()
                                         ->asESObject()
                                         ->extraPointerData())
                                        ->toggle(toBrowserString(argStr), false,
                                                 false);
                            } else {
    ...
    DOMTokenListFunction->protoType()
        .asESPointer()
        ->asESObject()
        ->defineDataProperty(escargot::ESString::create("toggle"), false, false,
                             false, domTokenListToggleFunction);

    escargot::ESFunctionObject* domTokenListToStringFunction =
        escargot::ESFunctionObject::create(
            NULL,
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                escargot::ESValue thisValue =
    ...
    DOMTokenListFunction->protoType()
        ...
        ->asESObject()
        ->defineDataProperty(escargot::ESString::create("toString"), true,
                             false, true, domTokenListToStringFunction);

    return DOMTokenListFunction;
}

escargot::ESFunctionObject* bindingDOMSettableTokenList(
    ScriptBindingInstance* scriptBindingInstance)
{
    ...
    escargot::ESFunctionObject* domSettableTokenListItemFunction =
        escargot::ESFunctionObject::create(
            NULL,
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                escargot::ESValue thisValue =
    ...
    DOMSettableTokenListFunction->protoType()
        ...
        ->asESObject()
        ->defineDataProperty(escargot::ESString::create("item"), false, false,
                             false, domSettableTokenListItemFunction);

    escargot::ESFunctionObject* domSettableTokenListContainsFunction =
        escargot::ESFunctionObject::create(
            NULL,
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                escargot::ESValue thisValue =
    ...
    escargot::ESFunctionObject* domSettableTokenListAddFunction =
        escargot::ESFunctionObject::create(
            NULL,
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                escargot::ESValue thisValue =
    ...
    DOMSettableTokenListFunction->protoType()
        ...
        ->asESObject()
        ->defineDataProperty(escargot::ESString::create("add"), false, false,
                             false, domSettableTokenListAddFunction);

    escargot::ESFunctionObject* domSettableTokenListRemoveFunction =
        escargot::ESFunctionObject::create(
            NULL,
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                escargot::ESValue thisValue =
    ...
    DOMSettableTokenListFunction->protoType()
        ...
        ->asESObject()
        ->defineDataProperty(escargot::ESString::create("remove"), false, false,
                             false, domSettableTokenListRemoveFunction);

    escargot::ESFunctionObject* domSettableTokenListToggleFunction =
        escargot::ESFunctionObject::create(
            NULL,
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                escargot::ESValue thisValue =
    ...
    DOMSettableTokenListFunction->protoType()
        ...
        ->asESObject()
        ->defineDataProperty(escargot::ESString::create("toggle"), false, false,
                             false, domSettableTokenListToggleFunction);

    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        DOMSettableTokenListFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("value"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(
                ScriptWrappable::Type::DOMSettableTokenListObject,
                DOMSettableTokenList);
...
escargot::ESFunctionObject* bindingNamedNodeMap(
    ScriptBindingInstance* scriptBindingInstance)
{
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        ...
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(
                ScriptWrappable::Type::NamedNodeMapObject, NamedNodeMap);
            uint32_t len = originalObj->length();
            return escargot::ESValue(len);
        },
        nullptr);

    escargot::ESFunctionObject* NamedNodeMapItemFunction =
        escargot::ESFunctionObject::create(
            NULL,
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                escargot::ESValue thisValue =
    ...
    NamedNodeMapFunction->protoType()
        ...
        ->asESObject()
        ->defineDataProperty(escargot::ESString::create("item"), false, false,
                             false, NamedNodeMapItemFunction);

    escargot::ESFunctionObject* NamedNodeMapGetNamedItemFunction =
        escargot::ESFunctionObject::create(
            NULL,
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                escargot::ESValue thisValue =
                ...
                if (argValue.isESString()) {
                    ...
                    auto attrName =
                        t->element()->document()->createAttributeName(key);
    ...
    NamedNodeMapFunction->protoType()
        .asESPointer()
        ->asESObject()
        ->defineDataProperty(escargot::ESString::create("getNamedItem"), false,
                             false, false, NamedNodeMapGetNamedItemFunction);

    escargot::ESFunctionObject* NamedNodeMapSetNamedItemFunction =
        escargot::ESFunctionObject::create(
            NULL,
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                escargot::ESValue thisValue =
                ...
                if (!((Node*)argValue.asESPointer()
                          ->asESObject()
                          ->extraPointerData())
                         ->isAttr()) {
                    THROW_ILLEGAL_INVOCATION()
                }
                Attr* passedAttr = (Attr*)argValue.asESPointer()
                                       ->asESObject()
                                       ->extraPointerData();
    ...
    NamedNodeMapFunction->protoType()
        .asESPointer()
        ->asESObject()
        ->defineDataProperty(escargot::ESString::create("setNamedItem"), false,
                             false, false, NamedNodeMapSetNamedItemFunction);

    escargot::ESFunctionObject* NamedNodeMapRemoveNamedItemFunction =
        escargot::ESFunctionObject::create(
            NULL,
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                escargot::ESValue thisValue =
    ...
    NamedNodeMapFunction->protoType()
        .asESPointer()
        ->asESObject()
        ->defineDataProperty(escargot::ESString::create("removeNamedItem"),
                             false, false, false,
                             NamedNodeMapRemoveNamedItemFunction);

    return NamedNodeMapFunction;
}

escargot::ESFunctionObject* bindingAttr(
    ScriptBindingInstance* scriptBindingInstance)
{
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        ...
        escargot::ESString::create("name"), attrNameValueGetter, nullptr);
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        AttrFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("localName"), attrNameValueGetter, nullptr);
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        AttrFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("value"), attrValueGetter, attrValueSetter);
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        AttrFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("nodeValue"), attrValueGetter,
        attrValueSetter);
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        AttrFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("textContent"), attrValueGetter,
        attrValueSetter);
    ...
    AttrFunction->protoType()
        ...
        ->asESObject()
        ->defineAccessorProperty(
            escargot::ESString::create("ownerElement"),
            [](::escargot::ESObject* obj, ::escargot::ESObject* originalObj,
               escargot::ESString* name) -> escargot::ESValue {
    ...
    AttrFunction->protoType()
        ...
        ->asESObject()
        ->defineAccessorProperty(
            escargot::ESString::create("specified"),
            [](::escargot::ESObject* obj, ::escargot::ESObject* originalObj,
               escargot::ESString* name) -> escargot::ESValue {
                CHECK_TYPEOF(originalObj, ScriptWrappable::Type::NodeObject);
                if (!((Node*)originalObj->extraPointerData())->isAttr()) {
...
escargot::ESFunctionObject* bindingCSSStyleDeclaration(
    ScriptBindingInstance* scriptBindingInstance)
{
    ...
    CSSStyleDeclarationFunction->protoType()
        ...
        ->asESObject()
        ->defineDataProperty(
            escargot::ESString::create("getPropertyValue"), true, true, true,
            escargot::ESFunctionObject::create(
                nullptr,
                [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                    try {
...
#undef MATCH_KEY
    ...
    CSSStyleDeclarationFunction->protoType()
        ...
        ->asESObject()
        ->defineDataProperty(
            escargot::ESString::create("setProperty"), true, true, true,
            escargot::ESFunctionObject::create(
                nullptr,
                [](escargot::ESVMInstance* instance) -> escargot::ESValue {
        try {
...
escargot::ESFunctionObject* bindingCSSStyleRule(
    ScriptBindingInstance* scriptBindingInstance)
{
...
escargot::ESFunctionObject* bindingXMLHttpRequest(
    ScriptBindingInstance* scriptBindingInstance)
{
        ...
        fetchData(scriptBindingInstance)
            ->m_instance->globalObject()
            ->defineDataProperty(XMLHttpRequestEventTargetString, true, false,
                                 true, XMLHttpRequestEventTargetFunction);

        /* XMLHttpRequest */
        escargot::ESFunctionObject* xhrElementFunction =
            escargot::ESFunctionObject::create(
                NULL,
                [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                    Window* wnd =
        ...
        xhrElementFunction->protoType()
            .asESPointer()
            ->asESObject()
            ->set__proto__(XMLHttpRequestEventTargetFunction->protoType());
        fetchData(scriptBindingInstance)
            ->m_instance->globalObject()
            ->defineDataProperty(escargot::ESString::create("XMLHttpRequest"),
                                 false, false, false, xhrElementFunction);
...
#define DEFINE_XHR_EVENT_HANDLER(eventName)                                   \
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(                  \
        ...
        defineNativeAccessorPropertyButNeedToGenerateJSFunction(
            xhrElementFunction->protoType().asESPointer()->asESObject(),
            escargot::ESString::create("timeout"),
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                GENERATE_THIS_AND_CHECK_TYPE(
                    ScriptWrappable::Type::XMLHttpRequestObject,
                    XMLHttpRequest);
        ...
        defineNativeAccessorPropertyButNeedToGenerateJSFunction(
            xhrElementFunction->protoType().asESPointer()->asESObject(),
            escargot::ESString::create("status"),
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                GENERATE_THIS_AND_CHECK_TYPE(
                    ScriptWrappable::Type::XMLHttpRequestObject,
                    XMLHttpRequest);
        ...
        defineNativeAccessorPropertyButNeedToGenerateJSFunction(
            xhrElementFunction->protoType().asESPointer()->asESObject(),
            escargot::ESString::create("responseText"),
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                GENERATE_THIS_AND_CHECK_TYPE(
                    ScriptWrappable::Type::XMLHttpRequestObject,
                    XMLHttpRequest);
        ...
        defineNativeAccessorPropertyButNeedToGenerateJSFunction(
            xhrElementFunction->protoType().asESPointer()->asESObject(),
            escargot::ESString::create("response"),
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                GENERATE_THIS_AND_CHECK_TYPE(
                    ScriptWrappable::Type::XMLHttpRequestObject,
                    XMLHttpRequest);
        ...
        defineNativeAccessorPropertyButNeedToGenerateJSFunction(
            xhrElementFunction->protoType().asESPointer()->asESObject(),
            escargot::ESString::create("responseType"),
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                GENERATE_THIS_AND_CHECK_TYPE(
                    ScriptWrappable::Type::XMLHttpRequestObject,
                    XMLHttpRequest);
        ...
        xhrElementFunction->asESObject()->defineDataProperty(
            escargot::ESString::create("UNSENT"), false, true, false,
            escargot::ESValue(0));
        xhrElementFunction->asESObject()->defineDataProperty(
            escargot::ESString::create("OPENED"), false, true, false,
            escargot::ESValue(1));
        xhrElementFunction->asESObject()->defineDataProperty(
            escargot::ESString::create("HEADERS_RECEIVED"), false, true, false,
            escargot::ESValue(2));
        xhrElementFunction->asESObject()->defineDataProperty(
            escargot::ESString::create("LOADING"), false, true, false,
            escargot::ESValue(3));
        xhrElementFunction->asESObject()->defineDataProperty(
            escargot::ESString::create("DONE"), false, true, false,
            escargot::ESValue(4));

        xhrElementFunction->protoType()
            .asESPointer()
            ->asESObject()
            ->defineDataProperty(escargot::ESString::create("UNSENT"), false,
                                 true, false, escargot::ESValue(0));
        xhrElementFunction->protoType()
            .asESPointer()
            ->asESObject()
            ->defineDataProperty(escargot::ESString::create("OPENED"), false,
                                 true, false, escargot::ESValue(1));
        xhrElementFunction->protoType()
            .asESPointer()
            ->asESObject()
            ->defineDataProperty(escargot::ESString::create("HEADERS_RECEIVED"),
                                 false, true, false, escargot::ESValue(2));
        xhrElementFunction->protoType()
            .asESPointer()
            ->asESObject()
            ->defineDataProperty(escargot::ESString::create("LOADING"), false,
                                 true, false, escargot::ESValue(3));
        xhrElementFunction->protoType()
            .asESPointer()
            ->asESObject()
            ->defineDataProperty(escargot::ESString::create("DONE"), false,
                                 true, false, escargot::ESValue(4));

        escargot::ESFunctionObject* xhrSetRequestHeaderFunction =
            escargot::ESFunctionObject::create(
                NULL,
                [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                    GENERATE_THIS_AND_CHECK_TYPE(
        ...
        xhrElementFunction->protoType()
            .asESPointer()
            ->asESObject()
            ->defineDataProperty(escargot::ESString::create("setRequestHeader"),
                                 false, false, false,
                                 xhrSetRequestHeaderFunction);

        escargot::ESFunctionObject* xhrOpenFunction =
            escargot::ESFunctionObject::create(
                NULL,
                [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                    GENERATE_THIS_AND_CHECK_TYPE(
        ...
        xhrElementFunction->protoType()
            .asESPointer()
            ->asESObject()
            ->defineDataProperty(escargot::ESString::create("open"), false,
                                 false, false, xhrOpenFunction);

        escargot::ESFunctionObject* xhrSendFunction =
            escargot::ESFunctionObject::create(
                NULL,
                [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                    GENERATE_THIS_AND_CHECK_TYPE(
        ...
        xhrElementFunction->protoType()
            .asESPointer()
            ->asESObject()
            ->defineDataProperty(escargot::ESString::create("send"), false,
                                 false, false, xhrSendFunction);

        escargot::ESFunctionObject* xhrAbortFunction =
            escargot::ESFunctionObject::create(
                NULL,
                [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                    GENERATE_THIS_AND_CHECK_TYPE(
        ...
        xhrElementFunction->protoType()
            .asESPointer()
            ->asESObject()
            ->defineDataProperty(escargot::ESString::create("abort"), false,
                                 false, false, xhrAbortFunction);

        return xhrElementFunction;
}

escargot::ESFunctionObject* bindingBlob(
    ScriptBindingInstance* scriptBindingInstance)
{
        /* Blob */
        auto BlobFunction = escargot::ESFunctionObject::create(
            NULL,
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                ...
                void* bytes = 0;
                escargot::ESValue lengthString =
                    escargot::currentInstance->strings().length.string();
                escargot::ESObject* obj = nullptr;
                escargot::ESValue lengthValue;

                if (!firstArg.isObject() ||
                    (lengthValue =
                         (obj = firstArg.toObject())->get(lengthString))
                        .isUndefinedOrNull()) {
                    auto msg = escargot::ESString::create(
                ...
                for (size_t i = 0; i < length; i++) {
                    ...
                    // otherwise, toString()
                    NullableUTF8String s = toBrowserString(element.toString())
                                               ->toNullableUTF8String();
                    bufferInfo.push_back(
        ...
        escargot::ESFunctionObject* BlobSliceFunction =
            escargot::ESFunctionObject::create(
                NULL,
                [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                    GENERATE_THIS_AND_CHECK_TYPE(
                        ScriptWrappable::Type::BlobObject, Blob);
                    escargot::ESValue arg0 =
                        instance->currentExecutionContext()->readArgument(0);
                    escargot::ESValue arg1 =
                        instance->currentExecutionContext()->readArgument(1);
        ...
        BlobFunction->protoType()
            .asESPointer()
            ->asESObject()
            ->defineDataProperty(escargot::ESString::create("slice"), false,
                                 false, false, BlobSliceFunction);

        return BlobFunction;
}

escargot::ESFunctionObject* bindingURL(
    ScriptBindingInstance* scriptBindingInstance)
{
#ifdef STARFISH_ENABLE_TEST
        escargot::ESFunctionObject* URLFunction =
            escargot::ESFunctionObject::create(
                NULL,
                [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                    int argCount =
                    ...
                    if (argCount < 1) {
                        ...
                        escargot::ESValue urlString =
                            instance->currentExecutionContext()->readArgument(
                                0);
                        auto url = URL::createURL(
                            String::emptyString,
                            String::fromUTF8(
                                urlString.asESString()->utf8Data()));
                        return url->scriptValue();
                    } else { // ignore redundant arguments
                        escargot::ESValue urlString =
                            instance->currentExecutionContext()->readArgument(
                                0);
                        escargot::ESValue baseURLString =
                            instance->currentExecutionContext()->readArgument(
                                1);
                        ...
                        auto url = URL::createURL(
                            String::fromUTF8(
                                baseURLString.asESString()->utf8Data()),
                            String::fromUTF8(
                                urlString.asESString()->utf8Data()));
                        return url->scriptValue();
                    }
    ...
    DEFINE_FUNCTION_NOT_CONSTRUCTOR(URL, fetchData(scriptBindingInstance)
                                             ...
                                             ->objectPrototype());
#endif
        escargot::ESFunctionObject* URLCreateObjectURLFunction =
            escargot::ESFunctionObject::create(
                NULL,
                [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                    escargot::ESValue arg0 =
                        instance->currentExecutionContext()->readArgument(0);
                    if (arg0.isObject() && (arg0.asObject()->extraData() ==
                                            kEscargotObjectCheckMagic) &&
                        ...
                        return toJSString(url);
                               ...
                               (arg0.asObject()->extraData() ==
                                kEscargotObjectCheckMagic) &&
                               ((ScriptWrappable*)arg0.asObject()
                                    ->extraPointerData())
                                       ->type() ==
                                   ScriptWrappable::Type::MediaSourceObject) {
                        MediaSource* m =
        ...
        URLFunction->defineDataProperty(
            escargot::ESString::create("createObjectURL"), false, false, false,
            URLCreateObjectURLFunction);

        escargot::ESFunctionObject* URLRevokeObjectURLFunction =
            escargot::ESFunctionObject::create(
                NULL,
                [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                    String* arg0 =
        ...
        URLFunction->defineDataProperty(
            escargot::ESString::create("revokeObjectURL"), false, false, false,
            URLRevokeObjectURLFunction);
        ...
        defineNativeAccessorPropertyButNeedToGenerateJSFunction(
            ...
            escargot::ESString::create("href"),
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::URLObject,
                                             URL);
        ...
        defineNativeAccessorPropertyButNeedToGenerateJSFunction(
            URLFunction->protoType().asESPointer()->asESObject(),
            escargot::ESString::create("origin"),
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::URLObject,
                                             URL);
        ...
        defineNativeAccessorPropertyButNeedToGenerateJSFunction(
            URLFunction->protoType().asESPointer()->asESObject(),
            escargot::ESString::create("protocol"),
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::URLObject,
                                             URL);
        ...
        defineNativeAccessorPropertyButNeedToGenerateJSFunction(
            URLFunction->protoType().asESPointer()->asESObject(),
            escargot::ESString::create("username"),
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::URLObject,
                                             URL);
        ...
        defineNativeAccessorPropertyButNeedToGenerateJSFunction(
            URLFunction->protoType().asESPointer()->asESObject(),
            escargot::ESString::create("password"),
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::URLObject,
                                             URL);
        ...
        defineNativeAccessorPropertyButNeedToGenerateJSFunction(
            URLFunction->protoType().asESPointer()->asESObject(),
            escargot::ESString::create("hostname"),
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::URLObject,
                                             URL);
        ...
        defineNativeAccessorPropertyButNeedToGenerateJSFunction(
            URLFunction->protoType().asESPointer()->asESObject(),
            escargot::ESString::create("pathname"),
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::URLObject,
                                             URL);
        ...
        defineNativeAccessorPropertyButNeedToGenerateJSFunction(
            URLFunction->protoType().asESPointer()->asESObject(),
            escargot::ESString::create("search"),
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::URLObject,
                                             URL);
...
/*
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        URLFunction->protoType().asESPointer()->asESObject(),
        escargot::ESString::create("searchParams"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
...
escargot::ESFunctionObject* bindingDOMRectReadOnly(
    ScriptBindingInstance* scriptBindingInstance)
{
        ...
        defineNativeAccessorPropertyButNeedToGenerateJSFunction(
            ...
            escargot::ESString::create("x"),
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                GENERATE_THIS_AND_CHECK_TYPE(
                    ScriptWrappable::Type::DOMRectReadOnlyObject,
                    DOMRectReadOnly);
        ...
        defineNativeAccessorPropertyButNeedToGenerateJSFunction(
            DOMRectReadOnlyFunction->protoType().asESPointer()->asESObject(),
            escargot::ESString::create("right"),
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                GENERATE_THIS_AND_CHECK_TYPE(
                    ScriptWrappable::Type::DOMRectReadOnlyObject,
                    DOMRectReadOnly);
        ...
        defineNativeAccessorPropertyButNeedToGenerateJSFunction(
            DOMRectReadOnlyFunction->protoType().asESPointer()->asESObject(),
            escargot::ESString::create("bottom"),
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                GENERATE_THIS_AND_CHECK_TYPE(
                    ScriptWrappable::Type::DOMRectReadOnlyObject,
                    DOMRectReadOnly);
...
escargot::ESFunctionObject* bindingDOMRect(
    ScriptBindingInstance* scriptBindingInstance)
{
        escargot::ESString* DOMRectString =
            escargot::ESString::create("DOMRect");
        auto DOMRectFunction = escargot::ESFunctionObject::create(
            NULL,
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                ...
                if (cnt == 0) {
                    ...
                    if (cnt == 1) {
                        ...
                        rect =
                            DOMRect::create(args[0], args[1], args[2], args[3]);
                    }
                }
                return rect->scriptValue();
            },
        ...
        defineNativeAccessorPropertyButNeedToGenerateJSFunction(
            ...
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                GENERATE_THIS_AND_CHECK_TYPE(
                    ScriptWrappable::Type::DOMRectObject, DOMRect);
...
escargot::ESFunctionObject* bindingDOMPointReadOnly(
    ScriptBindingInstance* scriptBindingInstance)
{
...
escargot::ESFunctionObject* bindingDOMPoint(
    ScriptBindingInstance* scriptBindingInstance)
{
        escargot::ESString* DOMPointString =
            escargot::ESString::create("DOMPoint");
        auto DOMPointFunction = escargot::ESFunctionObject::create(
            NULL,
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                ...
                if (cnt == 0) {
                    ...
                    point =
                        DOMPoint::create(args[0], args[1], args[2], args[3]);
                    return point->scriptValue();
                }
            },
        ...
        defineNativeAccessorPropertyButNeedToGenerateJSFunction(
            ...
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                GENERATE_THIS_AND_CHECK_TYPE(
                    ScriptWrappable::Type::DOMPointObject, DOMPoint);
...
escargot::ESFunctionObject* bindingDOMQuad(
    ScriptBindingInstance* scriptBindingInstance)
{
        /*
        ...
        */
        DEFINE_FUNCTION_NOT_CONSTRUCTOR(DOMQuad,
                                        fetchData(scriptBindingInstance)
                                            ->m_instance->globalObject()
                                            ->objectPrototype());
        ...
        defineNativeAccessorPropertyButNeedToGenerateJSFunction(
            ...
            escargot::ESString::create("p1"),
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                GENERATE_THIS_AND_CHECK_TYPE(
                    ScriptWrappable::Type::DOMQuadObject, DOMQuad);
        ...
        defineNativeAccessorPropertyButNeedToGenerateJSFunction(
            DOMQuadFunction->protoType().asESPointer()->asESObject(),
            escargot::ESString::create("bounds"),
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                GENERATE_THIS_AND_CHECK_TYPE(
                    ScriptWrappable::Type::DOMQuadObject, DOMQuad);
                DOMQuad* quad = originalObj;
...
escargot::ESFunctionObject* bindingDOMRectList(
    ScriptBindingInstance* scriptBindingInstance)
{
        ...
        DOMRectListFunction->protoType()
            ...
            ->asESObject()
            ->defineDataProperty(
                escargot::ESString::create("item"), true, true, true,
                escargot::ESFunctionObject::create(
                    NULL,
                    [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                        escargot::ESValue thisValue =
...
escargot::ESFunctionObject* bindingDOMException(
    ScriptBindingInstance* scriptBindingInstance)
{
        /* DOM Exception */
        ...
        DOMExceptionFunction->asESObject()->defineDataProperty(
            escargot::ESString::create("INDEX_SIZE_ERR"), false, false, false,
            escargot::ESValue(1));
        DOMExceptionFunction->asESObject()->defineDataProperty(
            escargot::ESString::create("HIERARCHY_REQUEST_ERR"), false, false,
            false, escargot::ESValue(3));
        DOMExceptionFunction->asESObject()->defineDataProperty(
            escargot::ESString::create("WRONG_DOCUMENT_ERR"), false, false,
            false, escargot::ESValue(4));
        DOMExceptionFunction->asESObject()->defineDataProperty(
            escargot::ESString::create("INVALID_CHARACTER_ERR"), false, false,
            false, escargot::ESValue(5));
        DOMExceptionFunction->asESObject()->defineDataProperty(
            escargot::ESString::create("NO_MODIFICATION_ALLOWED_ERR"), false,
            false, false, escargot::ESValue(7));
        DOMExceptionFunction->asESObject()->defineDataProperty(
            escargot::ESString::create("NOT_FOUND_ERR"), false, false, false,
            escargot::ESValue(8));
        DOMExceptionFunction->asESObject()->defineDataProperty(
            escargot::ESString::create("NOT_SUPPORTED_ERR"), false, false,
            false, escargot::ESValue(9));
        DOMExceptionFunction->asESObject()->defineDataProperty(
            escargot::ESString::create("INUSE_ATTRIBUTE_ERR"), false, false,
            false, escargot::ESValue(10));
        DOMExceptionFunction->asESObject()->defineDataProperty(
            escargot::ESString::create("INVALID_STATE_ERR"), false, false,
            false, escargot::ESValue(11));
        DOMExceptionFunction->asESObject()->defineDataProperty(
            escargot::ESString::create("SYNTAX_ERR"), false, false, false,
            escargot::ESValue(12));
        DOMExceptionFunction->asESObject()->defineDataProperty(
            escargot::ESString::create("INVALID_MODIFICATION_ERR"), false,
            false, false, escargot::ESValue(13));
        DOMExceptionFunction->asESObject()->defineDataProperty(
            escargot::ESString::create("NAMESPACE_ERR"), false, false, false,
            escargot::ESValue(14));
        DOMExceptionFunction->asESObject()->defineDataProperty(
            escargot::ESString::create("INVALID_ACCESS_ERR"), false, false,
            false, escargot::ESValue(15));
        DOMExceptionFunction->asESObject()->defineDataProperty(
            escargot::ESString::create("SECURITY_ERR"), false, false, false,
            escargot::ESValue(18));
        DOMExceptionFunction->asESObject()->defineDataProperty(
            escargot::ESString::create("NETWORK_ERR"), false, false, false,
            escargot::ESValue(19));
        DOMExceptionFunction->asESObject()->defineDataProperty(
            escargot::ESString::create("ABORT_ERR"), false, false, false,
            escargot::ESValue(20));
        DOMExceptionFunction->asESObject()->defineDataProperty(
            escargot::ESString::create("URL_MISMATCH_ERR"), false, false, false,
            escargot::ESValue(21));
        DOMExceptionFunction->asESObject()->defineDataProperty(
            escargot::ESString::create("QUOTA_EXCEEDED_ERR"), false, false,
            false, escargot::ESValue(22));
        DOMExceptionFunction->asESObject()->defineDataProperty(
            escargot::ESString::create("TIMEOUT_ERR"), false, false, false,
            escargot::ESValue(23));
        DOMExceptionFunction->asESObject()->defineDataProperty(
            escargot::ESString::create("INVALID_NODE_TYPE_ERR"), false, false,
            false, escargot::ESValue(24));
        DOMExceptionFunction->asESObject()->defineDataProperty(
            escargot::ESString::create("DATA_CLONE_ERR"), false, false, false,
            escargot::ESValue(25));

        DOMExceptionFunction->protoType()
            .asESPointer()
            ->asESObject()
            ->defineDataProperty(escargot::ESString::create("INDEX_SIZE_ERR"),
                                 false, false, false, escargot::ESValue(1));
        DOMExceptionFunction->protoType()
            .asESPointer()
            ->asESObject()
            ->defineDataProperty(
                escargot::ESString::create("HIERARCHY_REQUEST_ERR"), false,
                false, false, escargot::ESValue(3));
        DOMExceptionFunction->protoType()
            .asESPointer()
            ->asESObject()
            ->defineDataProperty(
        ...
        DOMExceptionFunction->protoType()
            ...
            ->asESObject()
            ->defineDataProperty(
                escargot::ESString::create("INVALID_CHARACTER_ERR"), false,
                false, false, escargot::ESValue(5));
        DOMExceptionFunction->protoType()
            .asESPointer()
            ->asESObject()
            ->defineDataProperty(
                escargot::ESString::create("NO_MODIFICATION_ALLOWED_ERR"),
                false, false, false, escargot::ESValue(7));
        DOMExceptionFunction->protoType()
            .asESPointer()
            ->asESObject()
            ->defineDataProperty(escargot::ESString::create("NOT_FOUND_ERR"),
                                 false, false, false, escargot::ESValue(8));
        DOMExceptionFunction->protoType()
            .asESPointer()
            ->asESObject()
            ->defineDataProperty(
        ...
        DOMExceptionFunction->protoType()
            .asESPointer()
            ->asESObject()
            ->defineDataProperty(escargot::ESString::create("SYNTAX_ERR"),
                                 false, false, false, escargot::ESValue(12));
        DOMExceptionFunction->protoType()
            .asESPointer()
            ->asESObject()
            ->defineDataProperty(
        ...
        DOMExceptionFunction->protoType()
            .asESPointer()
            ->asESObject()
            ->defineDataProperty(escargot::ESString::create("NAMESPACE_ERR"),
                                 false, false, false, escargot::ESValue(14));
        DOMExceptionFunction->protoType()
            .asESPointer()
            ->asESObject()
            ->defineDataProperty(
        ...
        DOMExceptionFunction->protoType()
            .asESPointer()
            ->asESObject()
            ->defineDataProperty(escargot::ESString::create("SECURITY_ERR"),
                                 false, false, false, escargot::ESValue(18));
        DOMExceptionFunction->protoType()
            .asESPointer()
            ->asESObject()
            ->defineDataProperty(escargot::ESString::create("NETWORK_ERR"),
                                 false, false, false, escargot::ESValue(19));
        DOMExceptionFunction->protoType()
            .asESPointer()
            ->asESObject()
            ->defineDataProperty(escargot::ESString::create("ABORT_ERR"), false,
                                 false, false, escargot::ESValue(20));
        DOMExceptionFunction->protoType()
            .asESPointer()
            ->asESObject()
            ->defineDataProperty(escargot::ESString::create("URL_MISMATCH_ERR"),
                                 false, false, false, escargot::ESValue(21));
        DOMExceptionFunction->protoType()
            .asESPointer()
            ->asESObject()
            ->defineDataProperty(
        ...
        DOMExceptionFunction->protoType()
            .asESPointer()
            ->asESObject()
            ->defineDataProperty(escargot::ESString::create("TIMEOUT_ERR"),
                                 false, false, false, escargot::ESValue(23));
        DOMExceptionFunction->protoType()
            .asESPointer()
            ->asESObject()
            ->defineDataProperty(
                escargot::ESString::create("INVALID_NODE_TYPE_ERR"), false,
                false, false, escargot::ESValue(24));
        DOMExceptionFunction->protoType()
            .asESPointer()
            ->asESObject()
            ->defineDataProperty(escargot::ESString::create("DATA_CLONE_ERR"),
                                 false, false, false, escargot::ESValue(25));

        return DOMExceptionFunction;
}
escargot::ESFunctionObject* bindingLocation(
    ScriptBindingInstance* scriptBindingInstance)
{
        DEFINE_FUNCTION_NOT_CONSTRUCTOR(Location,
                                        fetchData(scriptBindingInstance)
                                            ->m_instance->globalObject()
                                            ->objectPrototype());
        ...
        defineNativeAccessorPropertyButNeedToGenerateJSFunction(
            ...
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                GENERATE_THIS_AND_CHECK_TYPE(
                    ScriptWrappable::Type::LocationObject, LocationObj);
                return toJSString(originalObj->getHref());
            },
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                GENERATE_THIS_AND_CHECK_TYPE(
...
escargot::ESFunctionObject* bindingHistory(
    ScriptBindingInstance* scriptBindingInstance)
{
        DEFINE_FUNCTION_NOT_CONSTRUCTOR(History,
                                        fetchData(scriptBindingInstance)
                                            ->m_instance->globalObject()
                                            ->objectPrototype());
        HistoryFunction->protoType()
            ...
            ->asESObject()
            ->defineDataProperty(
                escargot::ESString::create("go"), false, false, false,
                escargot::ESFunctionObject::create(
                    nullptr,
                    [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                        GENERATE_THIS_AND_CHECK_TYPE(
        ...
        HistoryFunction->protoType()
            ...
            ->asESObject()
            ->defineDataProperty(
                escargot::ESString::create("back"), false, false, false,
                escargot::ESFunctionObject::create(
                    nullptr,
                    [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                        GENERATE_THIS_AND_CHECK_TYPE(
        ...
        HistoryFunction->protoType()
            ...
            ->asESObject()
            ->defineDataProperty(
                escargot::ESString::create("forward"), false, false, false,
                escargot::ESFunctionObject::create(
                    nullptr,
                    [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                        GENERATE_THIS_AND_CHECK_TYPE(
        ...
        HistoryFunction->protoType()
            ...
            ->asESObject()
            ->defineDataProperty(
                escargot::ESString::create("pushState"), false, false, false,
                escargot::ESFunctionObject::create(
                    nullptr,
                    [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                        GENERATE_THIS_AND_CHECK_TYPE(
                        ...
                        if (instance->currentExecutionContext()
                            ...
                            String* state = jsonStringify(
                                instance->currentExecutionContext()
                                    ->readArgument(0));
                            String* title = String::fromUTF8(
                                instance->currentExecutionContext()
                                    ->readArgument(1)
                                    .toString()
                                    ->utf8Data());
                            String* url = String::fromUTF8(
                                instance->currentExecutionContext()
                                    ->readArgument(2)
                                    .toString()
                                    ->utf8Data());
        ...
        HistoryFunction->protoType()
            ...
            ->asESObject()
            ->defineDataProperty(
                escargot::ESString::create("replaceState"), false, false, false,
                escargot::ESFunctionObject::create(
                    nullptr,
                    [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                        GENERATE_THIS_AND_CHECK_TYPE(
        ...
        defineNativeAccessorPropertyButNeedToGenerateJSFunction(
            HistoryFunction->protoType().asESPointer()->asESObject(),
            escargot::ESString::create("state"),
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                GENERATE_THIS_AND_CHECK_TYPE(
                    ScriptWrappable::Type::HistoryObject, History);
...
escargot::ESFunctionObject* bindingNavigator(
    ScriptBindingInstance* scriptBindingInstance)
{
        DEFINE_FUNCTION_NOT_CONSTRUCTOR(Navigator,
                                        fetchData(scriptBindingInstance)
                                            ->m_instance->globalObject()
                                            ->objectPrototype());
        ...
        defineNativeAccessorPropertyButNeedToGenerateJSFunction(
            ...
            escargot::ESString::create("appCodeName"),
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                GENERATE_THIS_AND_CHECK_TYPE(
                    ScriptWrappable::Type::NavigatorObject, Navigator);
        ...
        defineNativeAccessorPropertyButNeedToGenerateJSFunction(
            NavigatorFunction->protoType().asESPointer()->asESObject(),
            escargot::ESString::create("appName"),
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                GENERATE_THIS_AND_CHECK_TYPE(
                    ScriptWrappable::Type::NavigatorObject, Navigator);
        ...
        defineNativeAccessorPropertyButNeedToGenerateJSFunction(
            NavigatorFunction->protoType().asESPointer()->asESObject(),
            escargot::ESString::create("appVersion"),
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                GENERATE_THIS_AND_CHECK_TYPE(
                    ScriptWrappable::Type::NavigatorObject, Navigator);
        ...
        defineNativeAccessorPropertyButNeedToGenerateJSFunction(
            NavigatorFunction->protoType().asESPointer()->asESObject(),
            escargot::ESString::create("vendor"),
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                GENERATE_THIS_AND_CHECK_TYPE(
                    ScriptWrappable::Type::NavigatorObject, Navigator);
        ...
        defineNativeAccessorPropertyButNeedToGenerateJSFunction(
            NavigatorFunction->protoType().asESPointer()->asESObject(),
            escargot::ESString::create("userAgent"),
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                GENERATE_THIS_AND_CHECK_TYPE(
                    ScriptWrappable::Type::NavigatorObject, Navigator);
        ...
        defineNativeAccessorPropertyButNeedToGenerateJSFunction(
            NavigatorFunction->protoType().asESPointer()->asESObject(),
            escargot::ESString::create("geolocation"),
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                GENERATE_THIS_AND_CHECK_TYPE(
                    ScriptWrappable::Type::NavigatorObject, Navigator);
...
escargot::ESFunctionObject* bindingGeolocation(
    ScriptBindingInstance* scriptBindingInstance)
{
        ...
        escargot::ESFunctionObject* getCurrentPositionFunction =
            escargot::ESFunctionObject::create(
                nullptr,
                [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                    GENERATE_THIS_AND_CHECK_TYPE(
                    ...
                    if (opt.isObject()) {
                        ...
                        escargot::ESValue timeout = opt.asObject()->get(
                            escargot::ESString::create("timeout"));
                        ...
                        enableHighAccuracy =
                            opt.asObject()
                                ->get(escargot::ESString::create(
                                    "enableHighAccuracy"))
                                .toBoolean();
                    }

                    escargot::ESValue cb0 =
                        instance->currentExecutionContext()->readArgument(0);
                    escargot::ESValue cb1 =
                        instance->currentExecutionContext()->readArgument(1);
                    originalObj->getCurrentPosition(
                        [](StarFish*, Geoposition* pos, void* data) {
                            if (data) {
                                ...
                                callScriptFunction(fn, &a, 1,
                                                   ScriptValueUndefined);
                            }
                        },
        ...
        GeolocationFunction->protoType()
            ...
            ->asESObject()
            ->defineDataProperty(
                escargot::ESString::create("getCurrentPosition"), true, true,
                true, getCurrentPositionFunction);
        return GeolocationFunction;
}

escargot::ESFunctionObject* bindingGeoposition(
    ScriptBindingInstance* scriptBindingInstance)
{
        ...
        defineNativeAccessorPropertyButNeedToGenerateJSFunction(
            ...
            escargot::ESString::create("coords"),
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                GENERATE_THIS_AND_CHECK_TYPE(
...
escargot::ESFunctionObject* bindingCoordinates(
    ScriptBindingInstance* scriptBindingInstance)
{
        ...
        defineNativeAccessorPropertyButNeedToGenerateJSFunction(
            ...
            escargot::ESString::create("latitude"),
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                GENERATE_THIS_AND_CHECK_TYPE(
        ...
        defineNativeAccessorPropertyButNeedToGenerateJSFunction(
            CoordinatesFunction->protoType().asESPointer()->asESObject(),
            escargot::ESString::create("longitude"),
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                GENERATE_THIS_AND_CHECK_TYPE(
                    ScriptWrappable::Type::CoordinatesObject, Coordinates);
        ...
        defineNativeAccessorPropertyButNeedToGenerateJSFunction(
            CoordinatesFunction->protoType().asESPointer()->asESObject(),
            escargot::ESString::create("altitude"),
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                GENERATE_THIS_AND_CHECK_TYPE(
                    ScriptWrappable::Type::CoordinatesObject, Coordinates);
        ...
        defineNativeAccessorPropertyButNeedToGenerateJSFunction(
            CoordinatesFunction->protoType().asESPointer()->asESObject(),
            escargot::ESString::create("accuracy"),
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                GENERATE_THIS_AND_CHECK_TYPE(
                    ScriptWrappable::Type::CoordinatesObject, Coordinates);
        ...
        defineNativeAccessorPropertyButNeedToGenerateJSFunction(
            CoordinatesFunction->protoType().asESPointer()->asESObject(),
            escargot::ESString::create("altitudeAccuracy"),
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                GENERATE_THIS_AND_CHECK_TYPE(
                    ScriptWrappable::Type::CoordinatesObject, Coordinates);
        ...
        defineNativeAccessorPropertyButNeedToGenerateJSFunction(
            CoordinatesFunction->protoType().asESPointer()->asESObject(),
            escargot::ESString::create("heading"),
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                GENERATE_THIS_AND_CHECK_TYPE(
                    ScriptWrappable::Type::CoordinatesObject, Coordinates);
        ...
        defineNativeAccessorPropertyButNeedToGenerateJSFunction(
            CoordinatesFunction->protoType().asESPointer()->asESObject(),
            escargot::ESString::create("speed"),
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                GENERATE_THIS_AND_CHECK_TYPE(
                    ScriptWrappable::Type::CoordinatesObject, Coordinates);
...
escargot::ESFunctionObject* bindingPositionError(
    ScriptBindingInstance* scriptBindingInstance)
{
        ...
        defineNativeAccessorPropertyButNeedToGenerateJSFunction(
            PositionErrorFunction->protoType().asESPointer()->asESObject(),
            escargot::ESString::create("message"),
            [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                GENERATE_THIS_AND_CHECK_TYPE(
                    ScriptWrappable::Type::PositionErrorObject, PositionError);
        ...
        PositionErrorFunction->asESObject()->defineDataProperty(
            escargot::ESString::create("PERMISSION_DENIED"), false, false,
            false, escargot::ESValue(1));
        PositionErrorFunction->asESObject()->defineDataProperty(
            escargot::ESString::create("POSITION_UNAVAILABLE"), false, false,
            false, escargot::ESValue(2));
        PositionErrorFunction->asESObject()->defineDataProperty(
            escargot::ESString::create("TIMEOUT"), false, false, false,
            escargot::ESValue(3));
...
escargot::ESFunctionObject* bindingDOMParser(
    ScriptBindingInstance* scriptBindingInstance)
{
        /* XMLHttpRequest */
        escargot::ESFunctionObject* DOMParserFunction =
            escargot::ESFunctionObject::create(
                NULL,
                [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                    Window* wnd =
        ...
        fetchData(scriptBindingInstance)
            ->m_instance->globalObject()
            ->defineDataProperty(escargot::ESString::create("DOMParser"), false,
                                 false, false, DOMParserFunction);

        escargot::ESFunctionObject* parseFromStringFunction =
            escargot::ESFunctionObject::create(
                nullptr,
                [](escargot::ESVMInstance* instance) -> escargot::ESValue {
                    GENERATE_THIS_AND_CHECK_TYPE(
                        ScriptWrappable::Type::DOMParserObject, DOMParser);
        ...
        DOMParserFunction->protoType()
            .asESPointer()
            ->asESObject()
            ->defineDataProperty(escargot::ESString::create("parseFromString"),
                                 true, true, true, parseFromStringFunction);
...
String* ScriptBindingInstance::evaluate(String* str)
{
        ...
        if (setjmp(fetchData(this)->m_instance->registerTryPos(&tryPosition)) ==
            0) {
            auto result = fetchData(this)->m_instance->evaluate(
                toJSString(str).asESString());
            ...
            escargot::ESValue err =
                fetchData(this)->m_instance->getCatchedError();
