                ...
                if (instance->currentExecutionContext()->argumentCount() > 0) {
                    ...
                    if (argValue.isESString()) {
                        try {
                            ...
                            if (*argStr == *(escargot::strings->emptyString.string()))
                                throw new DOMException(elem->document()->window()->scriptBindingInstance(),
                                    DOMException::Code::DOM_EXCEPTION, "Failed to execute 'querySelectorAll' on 'Element': The provided selector is empty.");

                            NodeList* result = elem->querySelectorAll(toBrowserString(argStr));
                            if (result != nullptr)
                                return result->scriptValue();
                        } catch(DOMException* e) {
                            escargot::ESVMInstance::currentInstance()->throwError(e->scriptValue());
                    ...
                    auto msg = escargot::ESString::create("Failed to execute 'querySelectorAll' on 'Element': 1 argument required, but only 0 present.");
                    instance->throwError(escargot::ESValue(escargot::TypeError::create(msg)));
                }
#ifdef STARFISH_TC_COVERAGE
...
escargot::ESFunctionObject* bindingTextTrack(ScriptBindingInstance* scriptBindingInstance)
{
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        TextTrackFunction->protoType().asESPointer()->asESObject(), escargot::ESString::create("kind"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
        GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::TextTrackObject, TextTrack);
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        TextTrackFunction->protoType().asESPointer()->asESObject(), escargot::ESString::create("label"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
        GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::TextTrackObject, TextTrack);
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        TextTrackFunction->protoType().asESPointer()->asESObject(), escargot::ESString::create("language"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
        GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::TextTrackObject, TextTrack);
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        TextTrackFunction->protoType().asESPointer()->asESObject(), escargot::ESString::create("mode"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
        GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::TextTrackObject, TextTrack);
...
#define DEFINE_SOURCEBUFFER_EVENT_HANDLER(eventName) \
    defineNativeAccessorPropertyButNeedToGenerateJSFunction( \
        SourceBufferFunction->protoType().asESPointer()->asESObject(), escargot::ESString::create("on" #eventName), \
        [](escargot::ESVMInstance* instance) -> escargot::ESValue { \
        GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::SourceBufferObject, SourceBuffer); \
        auto eventname = (((Window*)instance->globalObject()->extraPointerData()))->starFish()->staticStrings()->m_##eventName; \
        return originalObj->attributeEventListener(eventname); \
    }, [](escargot::ESVMInstance* instance) -> escargot::ESValue { \
        GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::SourceBufferObject, SourceBuffer); \
        auto eventname = (((Window*)instance->globalObject()->extraPointerData()))->starFish()->staticStrings()->m_##eventName; \
            ...
            if (instance->currentExecutionContext()->argumentCount() > 0) {
                ...
                if (argValue.isESString()) {
                    try {
                        escargot::ESString* argStr = argValue.asESString();
                        if (*argStr == *(escargot::strings->emptyString.string()))
                            throw new DOMException(doc->window()->scriptBindingInstance(),
                                DOMException::Code::DOM_EXCEPTION, "Failed to execute 'querySelector' on 'Document': The provided selector is empty.");
            ...
            if (instance->currentExecutionContext()->argumentCount() > 0) {
                ...
                if (argValue.isESString()) {
                    try {
                        ...
                        if (*argStr == *(escargot::strings->emptyString.string()))
                            throw new DOMException(doc->window()->scriptBindingInstance(),
                                DOMException::Code::DOM_EXCEPTION, "Failed to execute 'querySelectorAll' on 'Document': The provided selector is empty.");
                ...
                auto msg = escargot::ESString::create("Failed to execute 'querySelectorAll' on 'Document': 1 argument required, but only 0 present.");
                instance->throwError(escargot::ESValue(escargot::TypeError::create(msg)));
            }
        } else {
            THROW_ILLEGAL_INVOCATION()
...
#ifdef STARFISH_ENABLE_MULTIMEDIA
        } else if (arg0.isObject() && (arg0.asObject()->extraData() == kEscargotObjectCheckMagic) && ((ScriptWrappable*)arg0.asObject()->extraPointerData())->type() == ScriptWrappable::Type::MediaSourceObject) {
...
escargot::ESFunctionObject* bindingDOMPoint(ScriptBindingInstance* scriptBindingInstance)
{
    ...
    DOMPointFunction->protoType().asESPointer()->asESObject()->forceNonVectorHiddenClass(false);
    DOMPointFunction->protoType().asESPointer()->asESObject()->set__proto__(fetchData(scriptBindingInstance)->domPointReadOnly()->protoType());
    DOMPointFunction->set__proto__(fetchData(scriptBindingInstance)->domPointReadOnly());

    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
    DOMPointFunction->protoType().asESPointer()->asESObject(), escargot::ESString::create("x"),
    [](escargot::ESVMInstance* instance) -> escargot::ESValue {
        GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::DOMPointObject, DOMPoint);
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
    DOMPointFunction->protoType().asESPointer()->asESObject(), escargot::ESString::create("y"),
    [](escargot::ESVMInstance* instance) -> escargot::ESValue {
        GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::DOMPointObject, DOMPoint);
        DOMPoint* point = originalObj;
        return escargot::ESValue(point->y());
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
    DOMPointFunction->protoType().asESPointer()->asESObject(), escargot::ESString::create("z"),
    [](escargot::ESVMInstance* instance) -> escargot::ESValue {
        GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::DOMPointObject, DOMPoint);
        DOMPoint* point = originalObj;
        return escargot::ESValue(point->z());
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
    DOMPointFunction->protoType().asESPointer()->asESObject(), escargot::ESString::create("w"),
    [](escargot::ESVMInstance* instance) -> escargot::ESValue {
        GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::DOMPointObject, DOMPoint);
        DOMPoint* point = originalObj;
        return escargot::ESValue(point->w());
...
escargot::ESFunctionObject* bindingLocation(ScriptBindingInstance* scriptBindingInstance)
{
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        LocationFunction->protoType().asESPointer()->asESObject(), escargot::ESString::create("host"),
        [](escargot::ESVMInstance* instance) -> escargot::ESValue {
        GENERATE_THIS_AND_CHECK_TYPE(ScriptWrappable::Type::LocationObject, LocationObj);
        return toJSString(originalObj->getHost());
    }, nullptr);
