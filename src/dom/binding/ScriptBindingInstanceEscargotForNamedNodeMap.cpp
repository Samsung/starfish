    ...
    ScriptBindingInstance* scriptBindingInstance)
{
    ...
    ESFunctionObject* NamedNodeMapItemFunction = ESFunctionObject::create(
        NULL,
        [](ESVMInstance* instance) -> ESValue {
            ESValue thisValue =
    ...
    NamedNodeMapFunction->protoType()
        ...
        ->defineDataProperty(ESString::create("item"), false, false, false,
                             NamedNodeMapItemFunction);

    ESFunctionObject* NamedNodeMapGetNamedItemFunction =
        ESFunctionObject::create(
            ...
            ESString::create("getNamedItem"), 1, false);
    NamedNodeMapFunction->protoType()
        .asESPointer()
        ->asESObject()
        ->defineDataProperty(ESString::create("getNamedItem"), false, false,
                             false, NamedNodeMapGetNamedItemFunction);

    ESFunctionObject* NamedNodeMapSetNamedItemFunction =
        ESFunctionObject::create(
            NULL,
            [](ESVMInstance* instance) -> ESValue {
                ESValue thisValue =
            ...
            ESString::create("setNamedItem"), 1, false);
    NamedNodeMapFunction->protoType()
        .asESPointer()
        ->asESObject()
        ->defineDataProperty(ESString::create("setNamedItem"), false, false,
                             false, NamedNodeMapSetNamedItemFunction);

    ESFunctionObject* NamedNodeMapRemoveNamedItemFunction =
        ESFunctionObject::create(
            NULL,
            [](ESVMInstance* instance) -> ESValue {
                ESValue thisValue =
            ...
            ESString::create("removeNamedItem"), 1, false);
    NamedNodeMapFunction->protoType()
        .asESPointer()
        ->asESObject()
        ->defineDataProperty(ESString::create("removeNamedItem"), false, false,
                             false, NamedNodeMapRemoveNamedItemFunction);
