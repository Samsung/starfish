    ...
    ScriptBindingInstance* scriptBindingInstance)
{
    ...
    ESFunctionObject* domTokenListItemFunction = ESFunctionObject::create(
        NULL,
        [](ESVMInstance* instance) -> ESValue {
            ESValue thisValue =
    ...
    DOMTokenListFunction->protoType()
        ...
        ->defineDataProperty(ESString::create("item"), false, false, false,
                             domTokenListItemFunction);

    ESFunctionObject* domTokenListContainsFunction = ESFunctionObject::create(
        NULL,
        [](ESVMInstance* instance) -> ESValue {
            ESValue thisValue =
                instance->currentExecutionContext()->resolveThisBinding();
    ...
    DOMTokenListFunction->protoType()
        ...
        ->defineDataProperty(ESString::create("contains"), false, false, false,
                             domTokenListContainsFunction);

    ESFunctionObject* domTokenListAddFunction = ESFunctionObject::create(
        NULL,
        [](ESVMInstance* instance) -> ESValue {
            ESValue thisValue =
                instance->currentExecutionContext()->resolveThisBinding();
    ...
    DOMTokenListFunction->protoType()
        ...
        ->defineDataProperty(ESString::create("add"), false, false, false,
                             domTokenListAddFunction);

    ESFunctionObject* domTokenListRemoveFunction = ESFunctionObject::create(
        NULL,
        [](ESVMInstance* instance) -> ESValue {
            ESValue thisValue =
                instance->currentExecutionContext()->resolveThisBinding();
    ...
    DOMTokenListFunction->protoType()
        ...
        ->defineDataProperty(ESString::create("remove"), false, false, false,
                             domTokenListRemoveFunction);

    ESFunctionObject* domTokenListToggleFunction = ESFunctionObject::create(
        NULL,
        [](ESVMInstance* instance) -> ESValue {
            ESValue thisValue =
                instance->currentExecutionContext()->resolveThisBinding();
            ...
            try {
                ...
                if (argCount == 0) {
                    instance->throwError(ESValue(TypeError::create(
                        ESString::create("Not enough arguments"))));
                }
                if (argCount >= 2) {
                    forceValue =
    ...
    DOMTokenListFunction->protoType()
        ...
        ->defineDataProperty(ESString::create("toggle"), false, false, false,
                             domTokenListToggleFunction);

    ESFunctionObject* domTokenListToStringFunction = ESFunctionObject::create(
        NULL,
        [](ESVMInstance* instance) -> ESValue {
            ESValue thisValue =
                instance->currentExecutionContext()->resolveThisBinding();
