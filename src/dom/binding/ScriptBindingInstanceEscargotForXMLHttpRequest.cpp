    ...
    ScriptBindingInstance* scriptBindingInstance)
{
    ...
    /* XMLHttpRequest */
    ESFunctionObject* xhrElementFunction = ESFunctionObject::create(
        NULL,
        ...
        ESString::create("XMLHttpRequest"), 0, true, false);
...
#undef DEFINE_XHR_EVENT_HANDLER
    ...
    defineNativeAccessorPropertyButNeedToGenerateJSFunction(
        ...
        [](ESVMInstance* instance) -> ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(
                ScriptWrappable::Type::XMLHttpRequestObject, XMLHttpRequest);
            try {
                ESString* str = instance->currentExecutionContext()
                                    ->readArgument(0)
                                    .toString();
                if (*str == "") {
    ...
    ESFunctionObject* xhrSetRequestHeaderFunction = ESFunctionObject::create(
        NULL,
        [](ESVMInstance* instance) -> ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(
                ScriptWrappable::Type::XMLHttpRequestObject, XMLHttpRequest);
        ...
        ESString::create("setRequestHeader"), 2, false);
    xhrElementFunction->protoType()
        .asESPointer()
        ->asESObject()
        ->defineDataProperty(ESString::create("setRequestHeader"), false, false,
                             false, xhrSetRequestHeaderFunction);

    ESFunctionObject* xhrOpenFunction = ESFunctionObject::create(
        NULL,
        [](ESVMInstance* instance) -> ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(
                ScriptWrappable::Type::XMLHttpRequestObject, XMLHttpRequest);
            try {
                if (instance->currentExecutionContext()->argumentCount() >= 2) {
                    ...
                    originalObj->open(
                        mt, toBrowserString(instance->currentExecutionContext()
                                                ->readArgument(1)),
    ...
    ESFunctionObject* xhrSendFunction = ESFunctionObject::create(
        NULL,
        [](ESVMInstance* instance) -> ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(
                ScriptWrappable::Type::XMLHttpRequestObject, XMLHttpRequest);
    ...
    ESFunctionObject* xhrAbortFunction = ESFunctionObject::create(
        NULL,
        [](ESVMInstance* instance) -> ESValue {
            GENERATE_THIS_AND_CHECK_TYPE(
                ScriptWrappable::Type::XMLHttpRequestObject, XMLHttpRequest);
