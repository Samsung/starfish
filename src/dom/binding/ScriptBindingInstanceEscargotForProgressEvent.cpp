...
{
    /* Progress Events */
    auto progressEventFunction = ESFunctionObject::create(
        NULL,
        [](ESVMInstance* instance) -> ESValue {
            ...
            if (argCount == 0) {
                ...
                if (secondArg.isObject()) {
                    ...
                    ESValue cancelable =
                        obj->get(ESString::create("cancelable"));
        ...
        ESString::create("ProgressEvent"), 1, true, true);
