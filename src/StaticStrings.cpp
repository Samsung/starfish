...
#undef DEFINE_PSEUDO_SELECTOR_LOCAL_NAMES
    ...
    m_ariaSetsize = QualifiedName(
        AtomicString::createAtomicString(starfish, "aria-setsize"));
    m_ariaValuenow = QualifiedName(
        AtomicString::createAtomicString(starfish, "aria-valuenow"));
    m_ariaValuemin = QualifiedName(
    ...
    m_markerUnits = QualifiedName(
        AtomicString::createAtomicString(starfish, "markerUnits"));
    m_reset =
    ...
    m_remove =
        QualifiedName(AtomicString::createAtomicString(starfish, "remove"));
