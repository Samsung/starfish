...
#ifndef SRC_TIZEN_AUDIO_DEVICE_AUDIO_DEVICE_IMPL_H_
#define SRC_TIZEN_AUDIO_DEVICE_AUDIO_DEVICE_IMPL_H_
...
class AudioDeviceModuleImplTizen : public AudioDeviceModuleForTest {
public:
    // Creates a default ADM for usage in production code.
    static rtc::scoped_refptr<AudioDeviceModule> Create(
        AudioLayer audio_layer, TaskQueueFactory* task_queue_factory,
        bool bypass_voice_processing = false);
    // Creates an ADM with support for extra test methods. Don't use this
    // factory in production code.
    ...
    AudioDeviceModuleImplTizen(AudioLayer audio_layer,
                               TaskQueueFactory* task_queue_factory,
                               bool bypass_voice_processing = false);
    ~AudioDeviceModuleImplTizen() override;
...
#endif // SRC_TIZEN_AUDIO_DEVICE_AUDIO_DEVICE_IMPL_H_
