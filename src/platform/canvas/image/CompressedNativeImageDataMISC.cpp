...
class CompressedNativeImageDataMISC : public CompressedNativeImageData {
public:
    void* operator new(size_t size)
    {
        return GC_GENERIC_MALLOC(sizeof(CompressedNativeImageDataMISC),
                                 NativeImageData::nativeImageDataGCKind());
    }

    CompressedNativeImageDataMISC(const std::vector<char>& compressedImageData,
                                  std::string&& imageURL)
        : m_image(nullptr)
        , m_width(0)
        , m_stride(0)
    ...
    virtual ~CompressedNativeImageDataMISC()
    {
...
{
    NativeImageData* imageData = new CompressedNativeImageDataMISC(
