...
StyleSheetListGetOwnPropertyCallback(ExecutionStateRef* state, ObjectRef* jsObj,
                                     ValueRef* key)
{
    StyleSheetList* self = (StyleSheetList*)jsObj->extraData();
    STARFISH_ASSERT(self->isStyleSheetList());
...
void StyleSheetListDefineOwnPropertyCallback(ExecutionStateRef* state,
...
StyleSheetListEnumerationCallback(ExecutionStateRef* state, ObjectRef* jsObj)
{
    StyleSheetList* self = (StyleSheetList*)jsObj->extraData();
